...
class ServerProtocolTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testWelcomeMessage() {
        ...
        $this->assertEquals(4, oldCount($json));
    ...
    public function testCall() {
        ...
        $this->assertEquals($paramNum, oldCount($this->_app->last['onCall'][3]));
    }
    ...
    public function testPublishAndEligible() {
        ...
        $this->assertEquals(array(), $this->_app->last['onPublish'][3]);
        $this->assertEquals(2, oldCount($this->_app->last['onPublish'][4]));
    }
    ...
    public function testGetSubProtocolsGetFromApp() {
        ...
        $this->assertGreaterThanOrEqual(3, oldCount($this->_comp->getSubProtocols()));
    }
