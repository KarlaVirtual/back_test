            ...
            foreach ($nodes as $node) {
                ...
                if (!empty($children)) {
                    ...
                    if ($childOptions['count'] !== null) {
                        if (oldCount($children) !== $childOptions['count']) {
                            break;
                        }
                    } // range count of children
                    elseif ($childOptions['less_than']    !== null &&
                            $childOptions['greater_than'] !== null) {
                        if (oldCount($children) >= $childOptions['less_than'] ||
                            oldCount($children) <= $childOptions['greater_than']) {
                            break;
                        }
                    ...
                    elseif ($childOptions['greater_than'] !== null) {
                        if (oldCount($children) <= $childOptions['greater_than']) {
                            break;
                        }
                    }
