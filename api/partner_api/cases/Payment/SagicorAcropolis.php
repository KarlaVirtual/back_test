...
try {
    ...
    padding-top: 20px;
">
                <img id="header-logo" src="https://images.virtualsoft.tech/m/msjT1623425307.png"
                     width="180"
                     alt="Logo">
                <p> The deposit has already been processed</p>

                <a href="https://www.acropolisonline.com/gestion/deposito" style="
    background: #03823c;
    padding: 16px;
    margin-top: 11px;
    position: relative;
...
"> Retornar al comercio </a>
    ...
    padding-top: 20px;
">
            <img id="header-logo" src="https://images.virtualsoft.tech/m/msjT1623425307.png" width="180"
                 alt="Logo">
            <p> Merchant: ACROPOLIS - Hosted Payment Page</p>
        ...
        <script type="text/javascript">
                    ...
                    formSessionUpdate: function (response) {
                        ...
                        if (response.status) {
                            if ("ok" == response.status) {
                                window.location.href = "https://partnerapi.virtualsoft.tech/Payment/ReturnAcropolis?id=<?=$_GET["id"]?>";
            ...
            function payWithCardSave(id, card) {
                $.ajax({
                    ...
                    type: 'POST',
                    url: "https://partnerapi.virtualsoft.tech/Payment/ReturnAcropolisSagicorCard",
                    dataType: "text",
                    cache: false,
                    data: {
                        id: id,
