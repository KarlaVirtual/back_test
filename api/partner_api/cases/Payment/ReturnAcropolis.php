...
try {
    ...
    if ($x_invoice != '' && is_numeric($x_invoice)) {
        ...
        if($TransaccionProducto->getEstado() == 'I'){
            ...
            $Mandante->baseUrl = 'https://www.acropolisonline.com/'; $redirect = $Mandante->baseUrl . '/gestion/deposito/correcto';

            header('Location: ' . $redirect);
        }
        if($TransaccionProducto->getEstado() != 'A') {
            $Mandante->baseUrl = 'https://www.acropolisonline.com/'; $redirect = $Mandante->baseUrl . '';
            ...
            if ($Result != "" && $Result != null) {
                ...
                if ($Result->response != null) {
                    if ($Result->response->acquirerCode == "00") {
                        ...
                        $Mandante->baseUrl = 'https://www.acropolisonline.com/'; $redirect = $Mandante->baseUrl . '/gestion/deposito/pendiente';
