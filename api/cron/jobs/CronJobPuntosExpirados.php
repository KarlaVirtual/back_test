...
; ";
        ...
        foreach ($Usuarios as $key => $value) {
            ...
            if ($Iduser != '' && $Iduser != '0') {
                /*Obtención periodo de expiración para puntos*/
...
SELECT usuario_puntoslealtad.usuario_id, 'S', '51', '" . $puntos . "', 'Expirados', 0, 0, 0, null, 0, usuario.mandante, usuario.pais_id,usuario_puntoslealtad.puntos_lealtad + usuario_puntoslealtad.puntos_aexpirar
from usuario_puntoslealtad
