...
///home/devadmin/api/api/
        ...
        $message = "*CRON: (Inicio) * " . " Resumenes-2AM - Fecha: " . date("Y-m-d H:i:s");
...
";
            ...
            if (true) {
                ...
                $message = "*CRON: (Fin) * " . " Resumenes-2AM PASO1 - Fecha: " . date("Y-m-d H:i:s");
                exec("php -f " . __DIR__ . "../src/imports/Slack/message.php '" . $message . "' '#procesos-cron-resumenes-error-urg' > /dev/null & ");
                ...
                if (false) {
                    ...
                    try {
                        ...
                        $sql2 = "rename table usuario_saldo to usuario_saldo_" . date("Y_m_d", strtotime('-0 days')) . ";";
...
create index " . $newTableCasinoTransprovisional . "_fecha_crea_index
    on " . $newTableCasinoTransprovisional . " (fecha_crea);
		...
		";
                ...
                $message = "*CRON: (Fin) * " . " Resumenes-2AM PASO2 - Fecha: " . date("Y-m-d H:i:s");
                exec("php -f " . __DIR__ . "../src/imports/Slack/message.php '" . $message . "' '#procesos-cron-resumenes-error-urg' > /dev/null & ");
...
WHERE usuario_saldo.mandante  in (17);';
...
FROM usuario where usuario.fecha_crea like "' . date("Y-m-d", strtotime('-1 days')) . '%" and   usuario.mandante  in (17);';
...
";
                    ...
                    $message = "*CRON: (Fin) * " . " Resumenes-2AM PASO2-5 - Fecha: " . date("Y-m-d H:i:s");
                    exec("php -f " . __DIR__ . "../src/imports/Slack/message.php '" . $message . "' '#procesos-cron-resumenes-error-urg' > /dev/null & ");
...
FROM usuario_saldo  where usuario_saldo.mandante  in (17);';
...
FROM usuario_saldo usuario_saldo  
...
ON DUPLICATE KEY UPDATE usuario_saldo.saldo_inicial      = '" . ((floatval($datanum->{'registro.creditos'}) + floatval($datanum->{'registro.creditos_base'}))) . "',
       ...
       " . $sqlValues;
                ...
                $message = "*CRON: (Fin) * " . " Resumenes-2AM PASO3 - Fecha: " . date("Y-m-d H:i:s");
                exec("php -f " . __DIR__ . "../src/imports/Slack/message.php '" . $message . "' '#procesos-cron-resumenes-error-urg' > /dev/null & ");

                if (!$primerMetodoDeInsercion) {


                    $sqlMandante = "select * from mandante where mandante  IN (17)";
...
";
                ...
                $procesoInterno = $BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('CapturaSaldos2AM','" . date("Y-m-d 00:00:00") . "','0');");


                $transaccion->commit();
                $message = "*CRON: (Fin) * " . " Resumenes-2AM PASO4 - Fecha: " . date("Y-m-d H:i:s");
                exec("php -f " . __DIR__ . "../src/imports/Slack/message.php '" . $message . "' '#procesos-cron-resumenes-error-urg' > /dev/null & ");
...
ON DUPLICATE KEY UPDATE usuario_saldo.saldo_final      = '" . $datanum->{'usuario_saldo.saldo_final'} . "',
       ...
       ";
            ...
            $message = "*CRON: (Fin) * " . " Resumenes-2AM - Fecha: " . date("Y-m-d H:i:s");
            exec("php -f " . __DIR__ . "../src/imports/Slack/message.php '" . $message . "' '#procesos-cron-resumenes' > /dev/null & ");
            exit();
...
ON DUPLICATE KEY UPDATE usuario_saldo.saldo_recarga      = '" . $datanum->{'.saldo_recarga'} . "',
       ...
       ";
            ...
            $message = "*CRON: (ERROR) (" . $e->getLine() . ") * " . " Resumenes-2AM - Fecha: " . date("Y-m-d H:i:s");
