...
/**
 * Clase 'CronJobPuntosLealtadDeportivas'
 *
 *
 *
 *
 ...
 *
 */
class CronJobPuntosLealtadDeportivas
{
        ...
        function runLealtadDeportivas($fechaL1, $fechaL2, $Mandante, $PaisId, $ActivateLealtad, Clasificador $Clasificador1)
        {
            ...
            try {
                ...
                if ($ActivateLealtad) {
                    ...
                    left join usuario_puntoslealtad on usuario_puntoslealtad.usuario_id = usuario.usuario_id
                    WHERE (it_ticket_enc.fecha_cierre_time) >= '" . $fechaL1 . "' AND (it_ticket_enc.fecha_cierre_time) <= '" . $fechaL2 . "' 
                    AND  it_ticket_enc.eliminado='N'  AND usuario_perfil.perfil_id='USUONLINE' AND it_ticket_enc.freebet='0'
                    ...
                    foreach ($usuariosPLealtad as $usuarioPLealtad) {
                        ...
                        $currentUserId = $usuarioPLealtad->{'usuario.usuario_id'};
                        ...
                        array_push($arrayUsuarios, $currentUserId);
                        try {
                            $sql = "UPDATE usuario_puntoslealtad set puntos_lealtad = puntos_lealtad + '" . $usuarioPLealtad->{'.u4'} . "' 
                            WHERE usuario_id = '" . $usuarioPLealtad->{'usuario.usuario_id'} . "'";
                            ...
                            '" . $usuarioPLealtad->{'.u7'} . "',
                            '" . $usuarioPLealtad->{'.u8'} . "',
                            (SELECT SUM(puntos_lealtad + puntos_aexpirar) FROM usuario_puntoslealtad WHERE usuario_id = '" . $usuarioPLealtad->{'usuario.usuario_id'} . "'),
                            '" . $usuarioPLealtad->{'.u10'} . "',
                            '" . $usuarioPLealtad->{'.u11'} . "',
                            '" . $usuarioPLealtad->{'.u12'} . "',
                            '" . $usuarioPLealtad->{'.u13'} . "',
...
SELECT * FROM proceso_interno2 WHERE tipo='LEALTADDEPORTIVAS'
";
            $filename = __DIR__ . '/lastruncronPuntosLealtadDeportivas';
...
#exec("php -f /home/home2/backendprodfinal/api/src/imports/Slack/message.php '".$message."' '#virtualsoft-cron' > /dev/null & ");
            ...
            runLealtadDeportivas($fechaL1, $fechaL2, 0, 173, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 0, 68, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 19, 173, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 0, 46, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 0, 94, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 23, 102, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 0, 66, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 0, 60, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 8, 66, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 27, 94, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 27, 68, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 21, 232, $ActivateLealtad, $Clasificador1);
            runLealtadDeportivas($fechaL1, $fechaL2, 21, 243, $ActivateLealtad, $Clasificador1);
            ...
            $sqlProcesoInterno2 = "
UPDATE proceso_interno2 SET fecha_ultima='" . $fechaL2 . "' WHERE  tipo='LEALTADDEPORTIVAS';
";
