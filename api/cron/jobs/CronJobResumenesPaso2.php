...
FROM (
       ...
       (SELECT usuario_id,
               ...
               0                                                    saldo_ajustes_entrada,
               0                                                    saldo_ajustes_salida,
               SUM(CASE when (estado = 'L' AND (tipo NOT IN ('TC','TL','SC','SCV','SL','TV','FC','DC', 'DL', 'DV', 'NC', 'NL', 'NV'))) then valor when (estado = 'E' AND (tipo NOT IN ('TC','TL','SC','SCV','SL','TV','FC','DC', 'DL', 'DV', 'NC', 'NL', 'NV'))) then -valor else 0 end) saldo_bono,
