...
/**
 * Clase 'CronJobResumenesPaso46AM'
 *
 *
 *
 *
 ...
 *
 */
class CronJobResumenesPaso46AM
{
    ...
    public function execute()
    {
        ...
        $message = "*CRON: (Inicio) * " . " ResumenesPaso4-6AM - Fecha: " . date("Y-m-d H:i:s");
...
where 1 = 1
  ...
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' and usuario.mandante in (3,4,5,6,7,10,22)
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ('PUNTOVENTA') and usuario.mandante in (3,4,5,6,7,10,22)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CAJERO') and usuario.mandante in (3,4,5,6,7,10,22)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CONCESIONARIO') and usuario.mandante in (3,4,5,6,7,10,22)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CONCESIONARIO2') and usuario.mandante in (3,4,5,6,7,10,22)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CONCESIONARIO3') and usuario.mandante in (3,4,5,6,7,10,22)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
            ...
            if (true) {
              ...
              VALUES (
                ...
                $procesoInterno = $BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso4-6AM','" . date("Y-m-d 00:00:00") . "','0');");
            ...
            $message = "*CRON: (Fin) * " . " ResumenesPaso4-6AM - Fecha: " . date("Y-m-d H:i:s");
            ...
            $message = "*CRON: (ERROR) * " . " ResumenesPaso4-6AM - Fecha: " . date("Y-m-d H:i:s");
