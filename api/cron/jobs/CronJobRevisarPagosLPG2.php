...
class CronJobRevisarPagosLPG2
{
    ...
    public function execute()
    {
        ...
        function sendGETRequest($URL, $array_tmp, $header = array())
        {
...
//$ProductoMandante = new ProductoMandante("","",$Banco->productoPago);
        ...
        foreach ($transacciones->data as $key => $value) {
            ...
            $transfer_status = $respuesta->transfer_status;
        ...
        $message = "*CRON: (Fin) * " . " PagosLPG - Fecha: " . date("Y-m-d H:i:s");
