...
///home/devadmin/api/api/
        ...
        $message = "*CRON: (Inicio) * " . " ResumenesPaso2RF - Fecha: " . date("Y-m-d H:i:s");
        ...
        if ($_REQUEST["diaSpc"] != "") {
            ...
            if ($arg1 != "") {
                ...
                if ($fechaSoloDia < date("Y-m-d", strtotime('-1 days'))) {
                    $nameTable = ' usuario_saldo_' . date("Y_m_d", strtotime($arg1)) . '_rf ';
                }
            } else {
                //exit();
            }
...
//BETWEEN '".$fecha1."' AND '".$fecha2."'
            ...
            $strEliminado = "DELETE FROM usuario_deporte_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
DELETE FROM usuario_casino_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
DELETE FROM usucasino_detalle_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
DELETE FROM usuario_retiro_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
DELETE FROM usuario_recarga_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
DELETE FROM usuario_bono_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
DELETE FROM usuario_ajustes_resumen_rf WHERE fecha_crea >= '" . $fecha1 . "';
";

            /* Recargas de USUARIOS por PUNTO DE VENTA por dia*/
  ...
  FROM usuario_recarga
    WHERE date_format(usuario_recarga.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' and puntoventa_id != 0 /*and estado='A'*/ AND usuario_recarga.mandante  IN (8)
...
SELECT
    ...
    COUNT(*) cantidad
  FROM usuario_recarga
    WHERE date_format(usuario_recarga.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_recarga.puntoventa_id != 0  AND usuario_recarga.mandante  IN (8)
  ...
  SELECT
    ...
    COUNT(*) cantidad
  FROM usuario_recarga
    WHERE date_format(usuario_recarga.fecha_elimina, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_recarga.puntoventa_id != 0 AND estado='I'  AND usuario_recarga.mandante  IN (8)
  GROUP BY date_format(usuario_recarga.fecha_elimina, '%Y-%m-%d'), usuario_recarga.puntoventa_id";


            /* Recargas hechos por usuario por PASARELAS por dia*/
...
SELECT
  ...
  FROM usuario_recarga
    ...
    INNER JOIN producto ON (transaccion_producto.producto_id = producto.producto_id)
    INNER JOIN proveedor ON (producto.proveedor_id = proveedor.proveedor_id)
    WHERE 
        proveedor.proveedor_id NOT IN (74,10,214) AND
        date_format(usuario_recarga.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND  usuario_recarga.puntoventa_id = 0  AND usuario_recarga.mandante  IN (8)
...
SELECT
  ...
  FROM usuario_recarga
    ...
    INNER JOIN proveedor ON (producto.proveedor_id = proveedor.proveedor_id)
    WHERE 
        proveedor.proveedor_id  IN (74,10,214) AND
        date_format(usuario_recarga.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND  usuario_recarga.puntoventa_id = 0  AND usuario_recarga.mandante  IN (8)
  GROUP BY date_format(usuario_recarga.fecha_crea, '%Y-%m-%d'),usuario_recarga.usuario_id, transaccion_producto.producto_id
  ORDER BY date_format(usuario_recarga.fecha_crea, '%Y-%m-%d'),usuario_recarga.usuario_id, transaccion_producto.producto_id;";
...
SELECT
  ...
  FROM cuenta_cobro
    WHERE cuenta_cobro.estado='I' AND date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.puntoventa_id != 0 AND cuenta_cobro.mandante  IN (8) AND cuenta_cobro.version in (1,2) 
...
SELECT
  ...
  FROM cuenta_cobro
    WHERE cuenta_cobro.estado='I' AND date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.puntoventa_id = 0  AND cuenta_cobro.transproducto_id = 0 AND cuenta_cobro.mandante  IN (8) AND cuenta_cobro.version in (1,2)
  GROUP BY date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d'), cuenta_cobro.usuario_id,cuenta_cobro.puntoventa_id, cuenta_cobro.version
  ORDER BY date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d'), cuenta_cobro.usuario_id,cuenta_cobro.puntoventa_id;";
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "'  AND cuenta_cobro.mandante  IN (8)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_accion, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.estado ='E' AND cuenta_cobro.mandante  IN (8)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_accion, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.estado ='D' AND cuenta_cobro.mandante  IN (8)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_accion, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.estado ='R' AND cuenta_cobro.mandante  IN (8)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE cuenta_cobro.estado IN ('A','M','S','P') AND cuenta_cobro.mandante  IN (8)
...
SELECT
  ...
  INNER JOIN transaccion_producto ON (transaccion_producto.transproducto_id = cuenta_cobro.transproducto_id)
    ...
    WHERE   cuenta_cobro.estado = 'I' AND date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d') = '" . $fechaSoloDia . "'  AND cuenta_cobro.mandante  IN (8)
  ...
  ORDER BY date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d'),cuenta_cobro.usuario_id, transaccion_producto.producto_id;";
            ...
            /* Retiros  pagados por PUNTOS DE VENTA por dia*/
            /*
            $sqlApuestasDeportivasUsuarioDia = "INSERT INTO usuario_deporte_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
                SELECT
            ...
            $sqlPremiosDeportivasUsuarioDia = "INSERT INTO usuario_deporte_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
            SELECT
              it_ticket_enc.usuario_id,
...
FROM it_transaccion
 ...
 INNER JOIN it_ticket_enc ON (it_ticket_enc.ticket_id = it_transaccion.ticket_id) 
    WHERE (it_transaccion.fecha_crea) = '" . $fechaSoloDia . "' AND usuario_perfil.perfil_id = \"USUONLINE\"    AND usuario_perfil.mandante  IN (8)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_crea) = '" . $fechaSoloDia . "'  AND it_ticket_enc.eliminado ='N' AND usuario_perfil.mandante  IN (8)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_cierre) = '" . $fechaSoloDia . "' AND  it_ticket_enc.eliminado='N' AND usuario_perfil.mandante  IN (8)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_cierre) = '" . $fechaSoloDia . "'  AND it_ticket_enc.premiado='S' AND it_ticket_enc.eliminado='N' AND usuario_perfil.mandante  IN (8)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_pago) = '" . $fechaSoloDia . "'AND it_ticket_enc.premiado='S' AND it_ticket_enc.eliminado='N' AND usuario_perfil.mandante  IN (8)
...
ORDER BY it_transaccion.usuario_id;";
            ...
            /*$sqlApuestasCasinoDia="INSERT INTO usuario_casino_resumen_rf (usuario_id, valor,valor_premios, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
            SELECT
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND transjuego_log.tipo LIKE '%DEBIT%'   AND usuario_mandante.mandante  IN (8)
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND (transjuego_log.tipo LIKE '%CREDIT%'OR transjuego_log.tipo like '%ROLLBACK%')   AND usuario_mandante.mandante  IN (8)
GROUP BY transaccion_juego.tipo,time_dimension.dbdate, transaccion_juego.usuario_id
ORDER BY time_dimension.dbdate,transaccion_juego.usuario_id;";
...
ORDER BY time_dimension.dbdate,transaccion_juego.usuario_id;";
            ...
            /*
            $sqlPremiosCasinoDia ="INSERT INTO usucasino_detalle_resumen_rf (usuario_id, producto_id, valor,valor_premios, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
            SELECT
              transaccion_juego.usuario_id,
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND (transjuego_log.tipo LIKE '%CREDIT%')   AND usuario_mandante.mandante  IN (8)
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND (transjuego_log.tipo like '%ROLLBACK%')   AND usuario_mandante.mandante  IN (8)
...
FROM bono_log
  ...
  and date_format(bono_log.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_perfil.perfil_id = \"USUONLINE\"    AND usuario_perfil.mandante  IN (8)
...
FROM saldo_usuonline_ajuste
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = saldo_usuonline_ajuste.usuario_id)
    ...
    WHERE  date_format(saldo_usuonline_ajuste.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_perfil.perfil_id = \"USUONLINE\"   AND usuario_perfil.mandante  IN (8)
...
FROM cupo_log
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = cupo_log.usuario_id)
    ...
    WHERE  date_format(cupo_log.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "'   AND usuario_perfil.mandante  IN (8)
...
SELECT   " . $nameTable . ".usuario_id,
         " . $nameTable . ".mandante,
         " . $nameTable . ".fecha,
         " . $nameTable . ".saldo_creditos_final,
         " . $nameTable . ".saldo_creditos_base_final,
         " . $nameTable . ".saldo_final
FROM   " . $nameTable . " 
...
SELECT   " . $nameTable . ".usuario_id,
         " . $nameTable . ".mandante,
         " . $nameTable . ".fecha,
         " . $nameTable . ".saldo_creditos_inicial,
         " . $nameTable . ".saldo_creditos_base_inicial,
         " . $nameTable . ".saldo_inicial
FROM   " . $nameTable . " 
where DATE_FORMAT(fecha, '%Y-%m-%d')   ='" . $fechaSoloDia . "'
...
FROM (
       (SELECT usuario_id,
               ...
               0    billetera_id
        FROM casino.usuario_recarga_resumen_rf
       ...
       (SELECT usuario_mandante,
               0                                   saldo_recarga,
               DATE_FORMAT(usuario_casino_resumen_rf.fecha_crea, '%Y-%m-%d') fecha,
               0                                   saldo_apuestas,
               0                                   saldo_premios,
               ...
               0                                   saldo_bono_free_ganado,
               0    billetera_id
        FROM casino.usuario_casino_resumen_rf
                                 INNER JOIN usuario_mandante ON (usumandante_id=usuario_id)
        WHERE tipo IN ('1','4','6') AND  (usuario_casino_resumen_rf.fecha_crea)   ='" . $fecha1 . "'
        GROUP BY usuario_id
       )
       ...
       (
         ...
         WHERE tipo IN ('2','5','7') AND  (usuario_casino_resumen_rf.fecha_crea)   ='" . $fecha1 . "'
         GROUP BY usuario_id
       )

       UNION

       (SELECT usuario_retiro_resumen_rf.usuario_id,
               0                                   saldo_recarga,
               DATE_FORMAT(fecha_crea, '%Y-%m-%d') fecha,
               0                                   saldo_apuestas,
               0                                   saldo_premios,
               0                                   saldo_apuestas_casino,
               0                                   saldo_premios_casino,
               SUM(usuario_retiro_resumen_rf.valor)                          saldo_notaret_pagadas,
               0                                   saldo_notaret_pend,
               0                                   saldo_notaret_creadas,
               0                                   saldo_ajustes_entrada,
               0                                   saldo_ajustes_salida,
               ...
               0                                   saldo_bono_free_ganado,
               0    billetera_id
        FROM casino.usuario_retiro_resumen_rf
        INNER JOIN usuario_perfil ON usuario_perfil.usuario_id = usuario_retiro_resumen_rf.usuario_id
        WHERE usuario_retiro_resumen_rf.estado = 'I' AND  (usuario_retiro_resumen_rf.fecha_crea)   ='" . $fecha1 . "' and usuario_perfil.perfil_id='USUONLINE'
        GROUP BY usuario_retiro_resumen_rf.usuario_id
       )
       ...
       (SELECT usuario_retiro_resumen_rf.usuario_id,
        ...
        FROM casino.usuario_retiro_resumen_rf
        INNER JOIN usuario_perfil ON usuario_perfil.usuario_id = usuario_retiro_resumen_rf.usuario_id
        WHERE usuario_retiro_resumen_rf.estado = 'D' AND  (usuario_retiro_resumen_rf.fecha_crea)   ='" . $fecha1 . "' and usuario_perfil.perfil_id='USUONLINE'
        GROUP BY usuario_retiro_resumen_rf.usuario_id
       )
       UNION
       ...
       (SELECT usuario_id,
               ...
               0    billetera_id
        FROM casino.usuario_retiro_resumen_rf
        WHERE estado = 'P' AND  (usuario_retiro_resumen_rf.fecha_crea)   ='" . $fecha1 . "'
        GROUP BY usuario_id
       )
       UNION
       ...
       (SELECT usuario_id,
               ...
               0                                   saldo_bono_free_ganado,
               0    billetera_id
        FROM casino.usuario_ajustes_resumen_rf
       ...
       (SELECT usuario_id,
               ...
               0                                   saldo_bono_free_ganado,
               0    billetera_id
        FROM casino.usuario_bono_resumen_rf
        WHERE DATE_FORMAT(fecha_crea, '%Y-%m-%d')   ='" . $fechaSoloDia . "'
        GROUP BY usuario_id
       )
    ...
    LEFT OUTER JOIN usuario_saldo_" . date("Y_m_d") . "_rf as data2 on (data.usuario_id = data2.usuario_id)

WHERE data.usuario_id IS NOT NULL AND usuario_perfil.perfil_id = 'USUONLINE'    AND usuario_perfil.mandante  IN (8)
...
FROM (
       ...
       (SELECT usuario_id,
               ...
               0                                   saldo_bono_free_ganado
        FROM casino.usuario_retiro_resumen_rf 
        WHERE estado = 'I' AND  (usuario_retiro_resumen_rf.fecha_crea)   ='" . $fecha1 . "' AND puntoventa_id=0
        GROUP BY usuario_id
       )
...
";
            ...
            if (false) {
                ...
                if (true) {
                    ...
                    foreach ($data as $datanum) {
                        $sql = "INSERT INTO usuario_recarga_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad,mediopago_id,puntoventa_id)
              VALUES ('" . $datanum->{'usuario_recarga.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'.mediopago_id'} . "','" . $datanum->{'usuario_recarga.puntoventa_id'} . "')";
                    ...
                    foreach ($data as $datanum) {
                        ...
                        $sql = "INSERT INTO usuario_recarga_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad)
              VALUES ('" . $datanum->{'.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "')";
                    ...
                    foreach ($data as $datanum) {
                        $sql = "INSERT INTO usuario_recarga_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad,mediopago_id)
              VALUES ('" . $datanum->{'usuario_recarga.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'transaccion_producto.mediopago_id'} . "')";
                    ...
                    print_r("PASO");
                    $data = $BonoInterno->execQuery('', $sqlRecargaPasarelaDiaRF);
                    ...
                    foreach ($data as $datanum) {
                        ...
                        $sql = "INSERT INTO usuario_deporte_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'usuario_recarga.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . 'A' . "','" . 'BET' . "','" . $datanum->{'.cantidad'} . "')";
                    ...
                    foreach ($data as $datanum) {
                        $sql = "INSERT INTO usuario_retiro_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad,puntoventa_id,version)
              ...
              VALUES ('" . $datanum->{'cuenta_cobro.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','0','" . $datanum->{'cuenta_cobro.version'} . "')";
                    ...
                    foreach ($data as $datanum) {
                        $sql = "INSERT INTO usuario_retiro_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad,version)
              ...
              VALUES ('" . $datanum->{'cuenta_cobro.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'cuenta_cobro.version'} . "')";
                    ...
                    foreach ($data as $datanum) {
                        $sql = "INSERT INTO usuario_retiro_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad,producto_id,version)
              ...
              VALUES ('" . $datanum->{'.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'it_ticket_enc.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'it_ticket_enc.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
                ...
                foreach ($data as $datanum) {
                    $sql = "INSERT INTO usuario_casino_resumen_rf (usuario_id, valor,valor_premios, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              ...
              VALUES ('" . $datanum->{'transaccion_juego.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.valor_premios'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
                ...
                foreach ($data as $datanum) {
                    $sql = "INSERT INTO usucasino_detalle_resumen_rf (usuario_id, producto_id, valor,valor_premios, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              ...
              VALUES ('" . $datanum->{'transaccion_juego.usuarioId'} . "','" . $datanum->{'transaccion_juego.producto_id'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.valor_premios'} . "','" . $datanum->{'.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
                ...
                foreach ($data as $datanum) {
                    $sql = "INSERT INTO usuario_bono_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'bono_log.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'bono_log.fecha_crea'} . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'bono_log.estado'} . "','" . $datanum->{'bono_log.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
                ...
                foreach ($data as $datanum) {
                    $sql = "INSERT INTO usuario_ajustes_resumen_rf (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, tipo, cantidad,tipo_ajuste,proveedor_id)
              ...
              ";
                ...
                //$procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso2RF','".date("Y-m-d 00:00:00")."','0');");
            ...
            print_r($UsuarioSaldoFinalConDetalles);
...
ON DUPLICATE KEY UPDATE   " . $nameTable . ".saldo_recarga      = '" . $datanum->{'.saldo_recarga'} . "',
       ...
       ";
                if ($datanum->{'data.usuario_id'} == 2739335) {
                    print_r($sql);
                }

                $BonoInterno->execQuery($transaccion, $sql);
                if (false) {
                    $sql = "INSERT INTO   " . $nameTable . " resumen (usuario_id, mandante, saldo_recarga, saldo_apuestas, saldo_premios,
                           saldo_apuestas_casino, saldo_premios_casino, saldo_notaret_pagadas,
                           saldo_notaret_pend, saldo_notaret_creadas, saldo_ajustes_entrada, saldo_ajustes_salida,
...
ON DUPLICATE KEY UPDATE   " . $nameTable . " resumen.saldo_recarga      =   " . $nameTable . " resumen.saldo_recarga + '" . $datanum->{'.saldo_recarga'} . "',
                           " . $nameTable . " resumen.saldo_apuestas      =   " . $nameTable . " resumen.saldo_apuestas + '" . $datanum->{'.saldo_apuestas'} . "',
                           " . $nameTable . " resumen.saldo_premios      =   " . $nameTable . " resumen.saldo_premios + '" . $datanum->{'.saldo_premios'} . "',
                           " . $nameTable . " resumen.saldo_apuestas_casino      =   " . $nameTable . " resumen.saldo_apuestas_casino + '" . $datanum->{'.saldo_apuestas_casino'} . "',
                           " . $nameTable . " resumen.saldo_premios_casino      =   " . $nameTable . " resumen.saldo_premios_casino + '" . $datanum->{'.saldo_premios_casino'} . "',
                           " . $nameTable . " resumen.saldo_notaret_pagadas      =   " . $nameTable . " resumen.saldo_notaret_pagadas + '" . $datanum->{'.saldo_notaret_pagadas'} . "',
                           " . $nameTable . " resumen.saldo_notaret_pend      =   " . $nameTable . " resumen.saldo_notaret_pend + '" . $datanum->{'.saldo_notaret_pend'} . "',
                           " . $nameTable . " resumen.saldo_notaret_creadas      =   " . $nameTable . " resumen.saldo_notaret_creadas + '" . $datanum->{'.saldo_notaret_creadas'} . "',
                           " . $nameTable . " resumen.saldo_ajustes_entrada      =   " . $nameTable . " resumen.saldo_ajustes_entrada + '" . $datanum->{'.saldo_ajustes_entrada'} . "',
                           " . $nameTable . " resumen.saldo_ajustes_salida      =   " . $nameTable . " resumen.saldo_ajustes_salida + '" . $datanum->{'.saldo_ajustes_salida'} . "',
                           " . $nameTable . " resumen.saldo_bono      =   " . $nameTable . " resumen.saldo_bono + '" . $datanum->{'.saldo_bono'} . "',
                           " . $nameTable . " resumen.saldo_notaret_eliminadas      =   " . $nameTable . " resumen.saldo_notaret_eliminadas + '" . $datanum->{'.saldo_notaret_eliminadas'} . "',
                           " . $nameTable . " resumen.saldo_bono_free_ganado      =   " . $nameTable . " resumen.saldo_bono_free_ganado + '" . $datanum->{'.saldo_bono_free_ganado'} . "'
...
ON DUPLICATE KEY UPDATE   " . $nameTable . " resumen.saldo_recarga      =   " . $nameTable . " resumen.saldo_recarga + '" . $datanum->{'.saldo_recarga'} . "',
       ...
       ";
            ...
            //$procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso2-2RF','".date("Y-m-d 00:00:00")."','0');");
            ...
            $message = "*CRON: (Fin) * " . " ResumenesPaso2RF - Fecha: " . date("Y-m-d H:i:s");
            ...
            $message = "*CRON: (ERROR) * " . " ResumenesPaso2RF - Fecha: " . date("Y-m-d H:i:s");
