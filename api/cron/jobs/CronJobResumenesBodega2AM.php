...
/**
 * Clase 'CronJobResumenesBodega2AM'
 *
 *
 *
 *
 ...
 *
 */
class CronJobResumenesBodega2AM
{
    ...
    public function execute()
    {
        ...
        foreach ($wallets as $wallet) {
            ...
            $message = "*CRON: (Inicio) * " . " ResumenesBodega-2AM - Fecha: " . date("Y-m-d H:i:s");
...
from (select a.mandante,
    ...
    select pais_mandante.mandante mandante,  '" . $fechaSoloDia . "' fecha_crea,  '" . $fechaSoloDia . "' fecha_cierre, pais_mandante.pais_id pais_id, pais.iso pais_iso, pais_moneda.moneda moneda,
      ...
      where 1 = 1
        and ((a.eliminado = 'S' AND a.fecha_crea != fecha_cierre AND a.fecha_cierre = '" . $fechaSoloDia . "') OR
...
from (select a.mandante,
    ...
    select pais_mandante.mandante mandante,  '" . $fechaSoloDia . "' fecha_crea,  '" . $fechaSoloDia . "' fecha_cierre, pais_mandante.pais_id pais_id, pais.iso pais_iso, pais_moneda.moneda moneda,
      ...
      group by a.mandante,up.perfil_id,a.fecha_crea, c.pais_id, b.moneda
                   ...
                   WHERE it_transaccion.fecha_crea = '" . $fechaSoloDia . "'
                     AND (it_transaccion.fecha_crea > it_ticket_enc.fecha_cierre) and it_ticket_enc.wallet='" . $wallet . "'
                    group by usuario.mandante, it_transaccion.fecha_crea, usuario.pais_id, usuario.moneda
                                      ) a
...
";
                ...
                foreach ($dataSaldoInicial as $datanum) {
                    ...
                    print_r($datanum);
                    $sql = "INSERT INTO bodega_informe_gerencial (pais_id, mandante, fecha, cantidad, saldo_apuestas, saldo_premios, saldo_premios_pendientes, saldo_bono, tipo_usuario, tipo_fecha, primeros_depositos,usuarios_registrados,billetera_id, , premio_jackpot) 
...
;
       ...
       ";
                ...
                foreach ($dataSaldoInicial as $datanum) {
                    ...
                    $sql = "INSERT INTO bodega_informe_gerencial (pais_id, mandante, fecha, cantidad, saldo_apuestas, saldo_premios, saldo_premios_pendientes, saldo_bono, tipo_usuario, tipo_fecha, primeros_depositos,usuarios_registrados,billetera_id) 
                    VALUES (" . $datanum->{'x.pais_id'} . ",
                    " . $datanum->{'x.mandante'} . ",
                    '" . $datanum->{'x.fecha_cierre'} . "',
                    '" . ($datanum->{'x.cant_tickets'} == '' ? 0 : $datanum->{'x.cant_tickets'}) . "',
       ...
       ";
                ...
                //$procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesBodega-2AM','".date("Y-m-d 00:00:00")."','0');");
                ...
                $message = "*CRON: (Fin) * " . " ResumenesBodega-2AM - Fecha: " . date("Y-m-d H:i:s");
                ...
                $message = "*CRON: (ERROR) * " . " ResumenesBodega-2AM - Fecha: " . date("Y-m-d H:i:s");
