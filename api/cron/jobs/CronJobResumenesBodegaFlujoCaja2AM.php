...
/**
 * Clase 'CronJobResumenesBodegaFlujoCaja2AM'
 *
 *
 *
 *
 ...
 *
 */
class CronJobResumenesBodegaFlujoCaja2AM
{
    ...
    public function execute()
    {
        ...
        $message = "*CRON: (Inicio) * " . " BodegaFlujoCaja-2AM - Fecha: " . date("Y-m-d H:i:s");
...
from (select *
      ...
      from (select d.nombre                                                                         punto_venta,
            ...
            where 1 = 1
              and (((x.fecha_crea))) >=
                  ('" . $fechaSoloDia . "')
              and (((x.fecha_crea))) <=
                  ('" . $fechaSoloDia . "') and d.mandante  IN (17)
      ...
      where z.fecha_crea <= ('" . $fechaSoloDia . "')
        ...
        and date(z.fecha_maxpago) >= date(now()) and d.mandante  IN (17)
...
order by y.usuario_id, y.fecha_crea";
       ...
       ";
            ...
            $procesoInterno = $BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesBodegaFlujoCaja-2AM','" . date("Y-m-d 00:00:00") . "','0');");
            ...
            $message = "*CRON: (Fin) * " . " BodegaFlujoCaja-2AM - Fecha: " . date("Y-m-d H:i:s");
            ...
            $message = "*CRON: (ERROR) * " . $e->getLine() . " BodegaFlujoCaja-2AM - Fecha: " . date("Y-m-d H:i:s");
