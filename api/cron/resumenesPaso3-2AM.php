...
$message = "*CRON: (Inicio) * " . " ResumenesPaso3-2AM - Fecha: " . date("Y-m-d H:i:s");
...
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
    ...
    if(true) {
        ...
        if(true) {
            ...
            foreach ($data as $datanum) {
                $sql = "INSERT INTO bodega_usuario_saldo (mandante, pais_id, fecha, tipo, saldo_recarga, saldo_apuestas, saldo_premios,
                                  ...
                                  saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas, desfase, saldo_ventas_loteria, saldo_rollbacks_loteria,
                                  cantidad_recargas)
              VALUES (
        ...
        $procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso3-2AM','".date("Y-m-d 00:00:00")."','0');");
    ...
    $message = "*CRON: (Fin) * " . " ResumenesPaso3-2AM - Fecha: " . date("Y-m-d H:i:s");
    ...
    $message = "*CRON: (ERROR) * " . " ResumenesPaso3-2AM - Fecha: " . date("Y-m-d H:i:s");
