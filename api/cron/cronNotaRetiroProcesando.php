...
for ($i = 0; $i < 10; $i++) {
    ...
    $sqlProcesoInterno2 = "SELECT * FROM proceso_interno2 WHERE tipo='ACTUALIZACIONRETIROSX'";
    ...
    $sqlProcesoInterno2 = "UPDATE proceso_interno2 SET fecha_ultima='" . $fechaL2 . "' WHERE  tipo='ACTUALIZACIONRETIROSX';";
