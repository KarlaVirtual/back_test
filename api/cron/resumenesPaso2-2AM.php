...
$message = "*CRON: (Inicio) * " . " ResumenesPaso2-2AM - Fecha: " . date("Y-m-d H:i:s");
...
";
  ...
  FROM usuario_recarga
    WHERE date_format(usuario_recarga.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' and puntoventa_id != 0 /*and estado='A'*/ AND usuario_recarga.mandante  IN (17)
...
SELECT
    ...
    COUNT(*) cantidad
  FROM usuario_recarga
    WHERE date_format(usuario_recarga.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_recarga.puntoventa_id != 0  AND usuario_recarga.mandante  IN (17)
  ...
  SELECT
    ...
    COUNT(*) cantidad
  FROM usuario_recarga
    WHERE date_format(usuario_recarga.fecha_elimina, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_recarga.puntoventa_id != 0 AND estado='I'  AND usuario_recarga.mandante  IN (17)
...
SELECT
  ...
  FROM cuenta_cobro
    WHERE cuenta_cobro.estado='I' AND date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.puntoventa_id != 0 AND cuenta_cobro.mandante  IN (17) AND cuenta_cobro.version in (1,2) 
...
SELECT
  ...
  FROM cuenta_cobro
    WHERE cuenta_cobro.estado='I' AND date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.puntoventa_id = 0  AND cuenta_cobro.transproducto_id = 0 AND cuenta_cobro.mandante  IN (17) AND cuenta_cobro.version in (1,2)
  GROUP BY date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d'), cuenta_cobro.usuario_id,cuenta_cobro.puntoventa_id, cuenta_cobro.version
  ORDER BY date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d'), cuenta_cobro.usuario_id,cuenta_cobro.puntoventa_id;";
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "'  AND cuenta_cobro.mandante  IN (17)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_accion, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.estado ='E' AND cuenta_cobro.mandante  IN (17)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_accion, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.estado ='D' AND cuenta_cobro.mandante  IN (17)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE date_format(cuenta_cobro.fecha_accion, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND cuenta_cobro.estado ='R' AND cuenta_cobro.mandante  IN (17)
...
SELECT
  ...
  FROM cuenta_cobro
    ...
    WHERE cuenta_cobro.estado IN ('A','M','S','P') AND cuenta_cobro.mandante  IN (17)
...
SELECT
  ...
  INNER JOIN transaccion_producto ON (transaccion_producto.transproducto_id = cuenta_cobro.transproducto_id)
    ...
    WHERE   cuenta_cobro.estado = 'I' AND date_format(cuenta_cobro.fecha_pago, '%Y-%m-%d') = '" . $fechaSoloDia . "'  AND cuenta_cobro.mandante  IN (17)
...
FROM it_transaccion
 ...
 INNER JOIN it_ticket_enc ON (it_ticket_enc.ticket_id = it_transaccion.ticket_id) 
    WHERE (it_transaccion.fecha_crea) = '" . $fechaSoloDia . "' AND usuario_perfil.perfil_id = \"USUONLINE\"    AND usuario_perfil.mandante  IN (17)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_crea) = '" . $fechaSoloDia . "'  AND it_ticket_enc.eliminado ='N' AND usuario_perfil.mandante  IN (17)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_cierre) = '" . $fechaSoloDia . "' AND  it_ticket_enc.eliminado='N' AND usuario_perfil.mandante  IN (17)
...
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usuario_id)
    ...
    WHERE (it_ticket_enc.fecha_cierre) = '" . $fechaSoloDia . "'  AND it_ticket_enc.premiado='S' AND it_ticket_enc.eliminado='N' AND usuario_perfil.mandante  IN (17)
...
SELECT
  CASE WHEN usuario_perfil.perfil_id != 'USUONLINE' then it_ticket_enc.usumodifica_id else 0 end usuarioId,
  ...
  SUM(CASE WHEN usuario_perfil.perfil_id != 'USUONLINE' then 1 ELSE 0 END) cantidad
FROM it_ticket_enc
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = it_ticket_enc.usumodifica_id)

    WHERE (it_ticket_enc.fecha_pago) = '" . $fechaSoloDia . "'AND it_ticket_enc.premiado='S' AND it_ticket_enc.eliminado='N' AND usuario_perfil.mandante  IN (17)

GROUP BY it_ticket_enc.wallet,it_ticket_enc.fecha_pago, it_ticket_enc.usumodifica_id HAVING usuarioId != '0'
ORDER BY it_ticket_enc.wallet,it_ticket_enc.usuario_id;";
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND transjuego_log.tipo LIKE '%DEBIT%'   AND usuario_mandante.mandante  IN (17)
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND (transjuego_log.tipo LIKE '%CREDIT%'OR transjuego_log.tipo like '%ROLLBACK%')   AND usuario_mandante.mandante  IN (17)
GROUP BY transaccion_juego.tipo,time_dimension.dbdate, transaccion_juego.usuario_id
ORDER BY time_dimension.dbdate,transaccion_juego.usuario_id;";
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND (transjuego_log.tipo LIKE '%CREDIT%')   AND usuario_mandante.mandante  IN (17)
...
SELECT
  ...
  COUNT(*) cantidad
    ...
    WHERE time_dimension.dbdate = '" . $fechaSoloDia . "' AND (transjuego_log.tipo like '%ROLLBACK%')   AND usuario_mandante.mandante  IN (17)
...
FROM bono_log
  ...
  and date_format(bono_log.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_perfil.perfil_id = \"USUONLINE\"    AND usuario_perfil.mandante  IN (17)
...
FROM saldo_usuonline_ajuste
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = saldo_usuonline_ajuste.usuario_id)
    ...
    WHERE  date_format(saldo_usuonline_ajuste.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "' AND usuario_perfil.perfil_id = \"USUONLINE\"   AND usuario_perfil.mandante  IN (17)
...
FROM cupo_log
  INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = cupo_log.usuario_id)
    ...
    WHERE  date_format(cupo_log.fecha_crea, '%Y-%m-%d') = '" . $fechaSoloDia . "'   AND usuario_perfil.mandante  IN (17)
...
FROM (
       ...
       (SELECT usuario_id,
               ...
               0                                                    saldo_ajustes_entrada,
               0                                                    saldo_ajustes_salida,
               SUM(CASE when (estado = 'L' AND (tipo NOT IN ({$globalJackpotTypesInBonoLog}, 'FC','TC','SC','SCV','SL','TL','TV'))) then valor when (estado = 'E' AND (tipo NOT IN ({$globalJackpotTypesInBonoLog}, 'FC','TC','SC','SCV','TL','TV'))) then -valor else 0 end) saldo_bono,
               SUM(CASE when (estado = 'L' AND (tipo IN ('TC','SC','SCV','SL','TL','TV'))) then valor when (estado = 'E' AND (tipo IN ('TC','SC','SCV','TL','TV'))) then -valor else 0 end) saldo_bono_casino_vivo,
               0                                   saldo_notaret_eliminadas,
               0                                   saldo_bono_free_ganado,
               SUM(CASE WHEN estado = 'L' AND tipo in ({$casinoJackpotTypesInBonoLog}) THEN valor ELSE 0 END)                                   saldo_premios_jackpot_casino,
               SUM(CASE WHEN estado = 'L' AND tipo in ({$sportbookJackpotTypesInBonoLog}) THEN valor ELSE 0 END)                                   saldo_premios_jackpot_deportivas,
               0                                   saldo_ventas_loteria,
               0                                   saldo_rollbacks_loteria,
               0    billetera_id
...
WHERE data.usuario_id IS NOT NULL AND usuario_perfil.perfil_id = 'USUONLINE'    AND usuario_perfil.mandante  IN (17)
...
";
    ...
    if(true) {
       ...
       // $BonoInterno->execQuery($transaccion, "set session wait_timeout=3000");
        ...
        if(true) {
            ...
            foreach ($data as $datanum) {
              ...
              VALUES ('" . $datanum->{'usuario_recarga.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'.mediopago_id'} . "','" . $datanum->{'usuario_recarga.puntoventa_id'} . "')";
            ...
            foreach ($data as $datanum) {
              ...
              VALUES ('" . $datanum->{'.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "')";
                $BonoInterno->execQuery($transaccion, $sql);
            }
            ...
            foreach ($data as $datanum) {
              ...
              VALUES ('" . $datanum->{'usuario_recarga.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'transaccion_producto.mediopago_id'} . "')";
                $BonoInterno->execQuery($transaccion, $sql);
            }
            ...
            foreach ($data as $datanum) {
              ...
              VALUES ('" . $datanum->{'cuenta_cobro.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'cuenta_cobro.puntoventa_id'} . "','" . $datanum->{'cuenta_cobro.version'} . "')";
                $BonoInterno->execQuery($transaccion, $sql);
            }
            ...
            foreach ($data as $datanum) {
                $sql = "INSERT INTO usuario_retiro_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, cantidad,puntoventa_id,version)
              VALUES ('" . $datanum->{'cuenta_cobro.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','0','" .  $datanum->{'cuenta_cobro.version'} . "')";
                $BonoInterno->execQuery($transaccion, $sql);
            }
            ...
            foreach ($data as $datanum) {
              ...
              VALUES ('" . $datanum->{'cuenta_cobro.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" .  $datanum->{'cuenta_cobro.version'} . "')";
                $BonoInterno->execQuery($transaccion, $sql);
            }
            ...
            foreach ($data as $datanum) {
              ...
              VALUES ('" . $datanum->{'cuenta_cobro.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'transaccion_producto.producto_id'} . "','" . $datanum->{'cuenta_cobro.version'} . "')";
                $BonoInterno->execQuery($transaccion, $sql);
            }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_deporte_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'it_transaccion.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'it_ticket_enc.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'it_transaccion.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_deporte_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'it_ticket_enc.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_casino_resumen (usuario_id, valor,valor_premios, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'transaccion_juego.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.valor_premios'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usucasino_detalle_resumen (usuario_id, producto_id, valor,valor_premios, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'transaccion_juego.usuarioId'} . "','" . $datanum->{'transaccion_juego.producto_id'} . "','" . $datanum->{'.valor'} . "','" . $datanum->{'.valor_premios'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.estado'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_bono_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, estado, tipo, cantidad)
              VALUES ('" . $datanum->{'bono_log.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'bono_log.estado'} . "','" . $datanum->{'bono_log.tipo'} . "','" . $datanum->{'.cantidad'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_ajustes_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, tipo, cantidad,tipo_ajuste,proveedor_id)
              VALUES ('" . $datanum->{'saldo_usuonline_ajuste.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'saldo_usuonline_ajuste.tipo'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'saldo_usuonline_ajuste.tipo_ajuste'} . "','" . $datanum->{'saldo_usuonline_ajuste.proveedor_id'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_ajustes_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, tipo, cantidad,tipo_ajuste,proveedor_id)
              VALUES ('" . $datanum->{'cupo_log.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'cupo_log.tipo'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'cupo_log.tipo_ajuste'} . "','" . $datanum->{'.proveedor_id'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO usuario_ajustes_resumen (usuario_id, valor, fecha_crea, usucrea_id, usumodif_id, tipo, cantidad,tipo_ajuste,proveedor_id)
              VALUES ('" . $datanum->{'cupo_log.usuarioId'} . "','" . $datanum->{'.valor'} . "','" . date("Y-m-d", strtotime('-1 days')) . "','" . $datanum->{'.usucrea_id'} . "','" . $datanum->{'.usumodif_id'} . "','" . $datanum->{'.tipo'} . "','" . $datanum->{'.cantidad'} . "','" . $datanum->{'cupo_log.tipo_ajuste'} . "','" . $datanum->{'.proveedor_id'} . "')";
            $BonoInterno->execQuery($transaccion, $sql);
        }
      ...
      ";
        ...
        $procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso2-2AM','".date("Y-m-d 00:00:00")."','0');");
    ...
    foreach ($data as $datanum) {
        ...
        $sql = "INSERT INTO usuario_saldo (usuario_id, mandante, fecha, saldo_recarga, saldo_apuestas, saldo_premios,
                           ...
                           saldo_creditos_final, saldo_creditos_base_final,saldo_notaret_eliminadas,saldo_bono_free_ganado, saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas,saldo_ventas_loteria,saldo_rollbacks_loteria,billetera_id) VALUES (
...
ON DUPLICATE KEY UPDATE usuario_saldo.saldo_recarga      = '" . $datanum->{'.saldo_recarga'} . "',
                         ...
                         usuario_saldo.saldo_ventas_loteria      = '" . $datanum->{'.saldo_ventas_loteria'} . "',
                         usuario_saldo.saldo_rollbacks_loteria      = '" . $datanum->{'.saldo_rollbacks_loteria'} . "',
...
ON DUPLICATE KEY UPDATE usuario_saldoresumen.saldo_recarga      = usuario_saldoresumen.saldo_recarga + '" . $datanum->{'.saldo_recarga'} . "',
    ...
    $transaccion = $BonoDetalleMySqlDAO->getTransaction();
    $transaccion->getConnection()->beginTransaction();
    $procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso2-2-2AM','".date("Y-m-d 00:00:00")."','0');");
    ...
    $message = "*CRON: (Fin) * " . " ResumenesPaso2-2AM - Fecha: " . date("Y-m-d H:i:s");
...
/*    try{
    ...
    $message = "*CRON: (ERROR) * " . " ResumenesPaso2-2AM - Fecha: " . date("Y-m-d H:i:s");
