    ...
    if (true) {
        ...
        if(false) {
            ...
            try {
                ...
                $sql2 = "rename table usuario_saldo_2023_07_24_rf to usuario_saldo_" . date("Y_m_d", strtotime('-2 days')) . "_rf;";

                $conn2->exec( $sql2);

                $sql2 = "rename table usuario_saldo_" . date("Y_m_d", strtotime('-1 days')) . "_rf to usuario_saldo_2023_07_24_rf;";
	...
	on " . $newTableUsuarioSaldo . " (usuario_id, fecha, billetera_id);
        ...
        if($primerMetodoDeInsercion){
            ...
            if(true) {
                ...
                $sqlUpdate = 'UPDATE usuario_saldo_2023_07_24_rf
SET usuario_saldo_2023_07_24_rf.saldo_final=usuario_saldo_2023_07_24_rf.saldo_inicial,
    usuario_saldo_2023_07_24_rf.saldo_creditos_final = usuario_saldo_2023_07_24_rf.saldo_creditos_inicial,
    usuario_saldo_2023_07_24_rf.saldo_creditos_base_final = usuario_saldo_2023_07_24_rf.saldo_creditos_base_inicial
WHERE usuario_saldo_2023_07_24_rf.mandante  in (8);';
            ...
            if (false) {
                ...
                $sqlInsert = 'INSERT INTO usuario_saldo_2023_07_24_rf
...
FROM usuario where usuario.fecha_crea like "' . date("Y-m-d", strtotime('-1 days')) . '%" and   usuario.mandante in (8);';
                ...
                foreach ($datosUsuariosNuevos as $datanum) {
                    ...
                    INSERT INTO usuario_saldo_2023_07_24_rf
(usuario_id, mandante, fecha, saldo_recarga, saldo_apuestas, saldo_premios, saldo_notaret_pagadas, saldo_notaret_pend, saldo_ajustes_entrada, saldo_ajustes_salida, saldo_inicial, saldo_final, saldo_bono, saldo_creditos_inicial, saldo_creditos_base_inicial, saldo_creditos_final, saldo_creditos_base_final, saldo_notaret_creadas, saldo_apuestas_casino, saldo_premios_casino, saldo_notaret_eliminadas, saldo_bono_free_ganado, saldo_bono_casino_free_ganado, saldo_bono_casino_vivo, saldo_bono_casino_vivo_free_ganado, saldo_bono_virtual, saldo_bono_virtual_free_ganado, billetera_id, saldo_apuestas_casino_vivo)
 VALUES (
            ...
            foreach ($usuHistorialIds2 as $item) {
                if($contUsu >= 1000){
                    if($usuHistorialIds != '0') {
                        ...
                        $sqlHistorial = "
            UPDATE usuario_saldo_2023_07_24_rf,usuario_historial
SET usuario_saldo_2023_07_24_rf.saldo_final=usuario_historial.creditos+usuario_historial.creditos_base,
    usuario_saldo_2023_07_24_rf.saldo_creditos_final = usuario_historial.creditos,
    usuario_saldo_2023_07_24_rf.saldo_creditos_base_final = usuario_historial.creditos_base
where usuario_historial.usuario_id=usuario_saldo_2023_07_24_rf.usuario_id
...
FROM usuario_saldo_2023_07_24_rf  where usuario_saldo_2023_07_24_rf.mandante  in (8);';
