...
SELECT * FROM proceso_interno2 WHERE tipo='TORNEOSPORTSBOOK'
";
    ...
    $sqlProcesoInterno2 = "
UPDATE proceso_interno2 SET fecha_ultima='" . $fechaL2 . "' WHERE  tipo='TORNEOSPORTSBOOK';
";
         ...
         INNER JOIN usuario_mandante ON (usuario_mandante.usuario_mandante = usuario.usuario_id and
                ...
                foreach ($dataUsuario as $key4 => $datanum) {
                    ...
                    if ($Sportsbook) {
                        ...
                        if (
                            !validarEventosRepetidos('deportes', $idDeportes, $puedeRepetirDeportes, $datanum->detallesFinal) ||
                            !validarEventosRepetidos('ligas', $idLigas, $puedeRepetirLigas, $datanum->detallesFinal) ||
                            !validarEventosRepetidos('mercados', $idMercados, $puedeRepetirMercados, $datanum->detallesFinal)
                        ) {
                            $cumpleCondicion = false;
                        }
...
where 1 = 1 and it_ticket_enc_info1.it_ticket2_id is null
  ...
  AND ((usuario_perfil.perfil_id)) = 'USUONLINE') a ON (a.ticket_id = it_ticket_det.ticket_id)
         ...
         INNER JOIN usuario_perfil ON (usuario_perfil.usuario_id = usuario.usuario_id); ";
                ...
                //SE HACE CONSULTA PARA APUESTAS GANADAS, PARA SISTEMA DE PUNTOS POR GANANCIA NETA
                if ($incomeNetPoint > 0) {
...
function validarEventosRepetidos($tipo, $idEventos, $puedeRepetir, $detallesFinal) {
    if (!empty($idEventos)) {
        ...
        $eventosRepetidos = obtenerEventosRepetidosEnApuesta($detallesFinal, $tipo);
