...
SELECT usuario.mandante,
       ...
       SUM(CASE WHEN usuario_perfil.perfil_id = 'USUONLINE' THEN saldo_impuestos_premios_deportivas ELSE 0 END)        saldo_impuestos_premios_deportivas,
...
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
    ...
    if(true) {
        ...
        if(true) {
            ...
            foreach ($data as $datanum) {
                $sql = "INSERT INTO bodega_usuario_saldo (mandante, pais_id, fecha, tipo, saldo_recarga, saldo_apuestas, saldo_premios,
                                  ...
                                  cantidad_recargas,saldo_impuestos_apuestas_deportivas,saldo_impuestos_premios_deportivas,saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas, saldo_ventas_loteria, saldo_rollbacks_loteria, saldo_impuestos_apuestas_casino,saldo_impuestos_depositos)
              VALUES (
        ...
        //$procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso3','".date("Y-m-d 00:00:00")."','0');");
