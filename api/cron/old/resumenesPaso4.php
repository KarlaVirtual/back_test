...
SELECT usuario.mandante,
       ...
       SUM(CASE WHEN usuario_perfil.perfil_id = 'USUONLINE' THEN saldo_premios_jackpot_deportivas ELSE 0 END) desfase,
        ...
        if(false) {
            ...
            foreach ($data as $datanum) {
                $sql = "INSERT INTO bodega_usuario_saldo (mandante, pais_id, fecha, tipo, saldo_recarga, saldo_apuestas, saldo_premios,
                                  ...
                                  saldo_bono_virtual_free_ganado, billetera_id, saldo_apuestas_casino_vivo, desfase, saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas, cantidad_recargas)
              VALUES (
