...
//$date1 ='2022-02-28 00:00:00';
//$date2 ='2022-02-28 23:59:59';
$date2 =date('Y-m-d 23:59:59',strtotime('+0 days'));
$date3 =date('Y-m-d H:i:s',strtotime('-90 days'));
/*$sql=
    "SELECT SUM(lealtad_historial.valor) AS puntos, (lealtad_historial.usuario_id) as usuarioId
FROM lealtad_historial
WHERE fecha_exp >= '$date1'  and movimiento = 'E'
AND fecha_exp <= '$date2' GROUP BY  usuario_id" ;*/
