...
$message = "*CRON: (Inicio) * " . " ResumenesPaso4-2AM - Fecha: " . date("Y-m-d H:i:s");
...
where 1 = 1
  ...
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' and usuario.mandante  IN (17)
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ('PUNTOVENTA') and usuario.mandante  IN (17)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CAJERO') and usuario.mandante  IN (17)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CONCESIONARIO') and usuario.mandante  IN (17)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CONCESIONARIO2') and usuario.mandante  IN (17)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
where 1 = 1
  AND ((usuario_saldo.fecha)) >= '" . $fechaSoloDia . "' 
  AND ((usuario_saldo.fecha)) <= '" . $fechaSoloDia . "' 
  AND ((usuario_perfil.perfil_id)) IN ( 'CONCESIONARIO3') and usuario.mandante  IN (17)
GROUP BY usuario.mandante, usuario.pais_id, usuario_saldo.fecha;";
...
print_r($sqlUsuarioSaldoResumen_PuntoVenta);
        ...
        foreach ($data as $datanum) {
            $sql = "INSERT INTO bodega_usuario_saldo (mandante, pais_id, fecha, tipo, saldo_recarga, saldo_apuestas, saldo_premios,
                                  ...
                                  saldo_bono_casino_vivo, saldo_bono_casino_vivo_free_ganado, saldo_bono_virtual,
                                  saldo_bono_virtual_free_ganado, billetera_id, saldo_apuestas_casino_vivo, desfase, 
                                  saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas,
                                  cantidad_recargas)
              VALUES (
                                         '" . $datanum->{'usuario.mandante'} . "',
                                         '" . $datanum->{'pais.pais_id'} . "',
        ...
        $procesoInterno=$BonoInterno->execQuery($transaccion, "INSERT INTO procesos_internos ( tipo, fecha_crea, usucrea_id) VALUES ('ResumenesPaso4-2AM','".date("Y-m-d 00:00:00")."','0');");
    ...
    $message = "*CRON: (Fin) * " . " ResumenesPaso4-2AM - Fecha: " . date("Y-m-d H:i:s");
    ...
    $message = "*CRON: (ERROR) * " . " ResumenesPaso4-2AM - Fecha: " . date("Y-m-d H:i:s");
