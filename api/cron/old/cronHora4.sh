...
/usr/bin/php $API_DIR/cron/resumenesPaso2RF.php
/usr/bin/php $API_DIR/cron/resumenesPaso3RF.php
/usr/bin/php $API_DIR/cron/resumenesPaso4RF.php
/usr/bin/php $API_DIR/cron/resumenesComisiones.php
/usr/bin/php $API_DIR/cron/resumenesBodegaRF.php
/usr/bin/php $API_DIR/cron/resumenesBodegaFlujoCajaRF.php
