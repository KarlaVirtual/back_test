...
";
    ...
    foreach ($data as $datanum) {
        ...
        $sql = "INSERT INTO usuario_saldo (usuario_id, mandante, fecha, saldo_recarga, saldo_apuestas, saldo_premios,
                           ...
                           saldo_creditos_final, saldo_creditos_base_final,saldo_notaret_eliminadas,saldo_bono_free_ganado, saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas,billetera_id) VALUES (
