        ...
        if(true) {
            ...
            foreach ($data as $datanum) {
                $sql = "INSERT INTO bodega_usuario_saldo (mandante, pais_id, fecha, tipo, saldo_recarga, saldo_apuestas, saldo_premios,
                                  ...
                                  cantidad_recargas,saldo_impuestos_apuestas_deportivas,saldo_impuestos_premios_deportivas,saldo_premios_jackpot_casino, saldo_premios_jackpot_deportivas)
              VALUES (
