...
namespace Backend\imports\MobileDetect;
...
class MobileDetect
{
    ...
    public function setHttpHeaders($httpHeaders = null)
    {
        ...
        if (!is_array($httpHeaders) || !oldCount($httpHeaders)) {
            $httpHeaders = $_SERVER;
        }
    ...
    public function setCfHeaders($cfHeaders = null) {
        ...
        if (!is_array($cfHeaders) || !oldCount($cfHeaders)) {
            $cfHeaders = $_SERVER;
        }
    ...
    public function setUserAgent($userAgent = null)
    {
        ...
        if (oldCount($this->getCfHeaders()) > 0) {
