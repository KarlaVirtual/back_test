...
class ArrayCookieJarTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testStoresAndRetrievesCookies()
    {
        ...
        $this->assertEquals(3, oldCount($this->jar));
        $this->assertEquals(3, oldCount($this->jar->getIterator()));
    ...
    public function testIsSerializable()
    {
        ...
        $this->assertEquals(1, oldCount($data));

        $a = new ArrayCookieJar();
        $a->unserialize($serialized);
        $this->assertEquals(1, oldCount($a));
    }
    ...
    public function testRemovesSelectively()
    {
        ...
        $this->assertEquals(2, oldCount($this->jar));
        ...
        $this->assertEquals(1, oldCount($this->jar));

        // Remove cookie by name
        $this->jar->remove(null, null, 'test');
        $this->assertEquals(0, oldCount($this->jar));
    }
    ...
    public function testAddsCookiesFromResponseWithNoRequest()
    {
        ...
        $this->assertEquals(3, oldCount($this->jar));
        $this->assertEquals(1, oldCount($this->jar->all(null, null, 'fpc')));
        $this->assertEquals(1, oldCount($this->jar->all(null, null, 'FPCK3')));
        $this->assertEquals(1, oldCount($this->jar->all(null, null, 'CH')));
    }
    ...
    public function testReturnsCookiesMatchingRequests($url, $cookies)
    {
        ...
        $this->assertEquals(oldCount($cookies), oldCount($results));
