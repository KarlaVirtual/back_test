...
class CurlMultiProxyTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testTrimsDownMaxHandleCount()
    {
        ...
        $this->assertEquals(2, oldCount($handles));
    }
}
