...
class CurlMultiTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testRequestsCanBeAddedAndCounted()
    {
        ...
        $this->assertEquals(2, oldCount($multi));
    }
    ...
    public function testSendsThroughCurlAndAggregatesRequestExceptions()
    {
        ...
        try {
            ...
            $this->assertEquals(1, oldCount($e));
            ...
            $this->assertEquals(1, oldCount($e->getFailedRequests()));
            $this->assertEquals(2, oldCount($e->getSuccessfulRequests()));
            $this->assertEquals(3, oldCount($e->getAllRequests()));
        }
    }
    ...
    public function testRemovesQueuedRequestsAddedInTransit()
    {
        ...
        $r->send();
        $this->assertEquals(1, oldCount($this->getServer()->getReceivedRequests(false)));
    }
    ...
    public function testCatchesExceptionsBeforeSendingSingleRequest()
    {
        ...
        try {
            ...
            $this->assertEquals(0, oldCount($multi));
        }
    }
    ...
    public function testDoesNotThrowExceptionsWhenRequestsRecoverWithRetry()
    {
        ...
        $multi->add($request);
        $multi->send();
        $this->assertEquals(0, oldCount($this->getServer()->getReceivedRequests(false)));
    }
