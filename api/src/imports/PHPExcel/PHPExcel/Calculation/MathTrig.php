...
class PHPExcel_Calculation_MathTrig
{
    ...
    public static function GCD()
    {
        ...
        $allValuesCount = oldCount($allValuesFactors);
        if ($allValuesCount == 0) {
            return 0;
        }
        ...
        $mergedArrayValues = oldCount($mergedArray);
    ...
    public static function SUMPRODUCT()
    {
        ...
        $wrkCellCount = oldCount($wrkArray);
    ...
    public static function SUMX2MY2($matrixData1, $matrixData2)
    {
        ...
        $count = min(oldCount($array1), oldCount($array2));
