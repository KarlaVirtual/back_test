    ...
    private function readPropertySets()
    {
        ...
        while ($offset < $entryLen) {
            ...
            if (($upName === 'WORKBOOK') || ($upName === 'BOOK')) {
                $this->wrkbook = oldCount($this->props) - 1;
            } elseif ($upName === 'ROOT ENTRY' || $upName === 'R') {
                // Root entry
                $this->rootentry = oldCount($this->props) - 1;
            }

            // Summary information
            if ($name == chr(5) . 'SummaryInformation') {
//                echo 'Summary Information<br />';
                $this->summaryInformation = oldCount($this->props) - 1;
            }

            // Additional Document Summary information
            if ($name == chr(5) . 'DocumentSummaryInformation') {
//                echo 'Document Summary Information<br />';
                $this->documentSummaryInformation = oldCount($this->props) - 1;
            }
