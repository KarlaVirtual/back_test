    ...
    public function close()
    {
        ...
        switch (get_class($this->object)) {
            ...
            case 'PHPExcel_Shared_Escher_DggContainer_BstoreContainer':
                ...
                // write the record
                $recVer            = 0xF;
                $recInstance    = oldCount($this->object->getBSECollection());
                $recType        = 0xF001;
                $length            = strlen($innerData);
            ...
            case 'PHPExcel_Shared_Escher_DgContainer':
                ...
                $countShapes = oldCount($this->object->getSpgrContainer()->getChildren());
            ...
            case 'PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer':
                ...
                if ($this->object->getOPTCollection()) {
                    ...
                    $recVer            = 0x3;
                    $recInstance    = oldCount($this->object->getOPTCollection());
                    $recType        = 0xF00B;
