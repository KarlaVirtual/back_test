    ...
    public function save($pFilename = null)
    {
        if ($this->spreadSheet !== null) {
            ...
            for ($i = 0; $i < $this->spreadSheet->getSheetCount(); ++$i) {
                ...
                $drawingCount = oldCount($drawings);
                if ($this->includeCharts) {
                ...
                if (oldCount($this->spreadSheet->getSheet($i)->getComments()) > 0) {
                    // VML Comments
                ...
                if (oldCount($this->spreadSheet->getSheet($i)->getHeaderFooter()->getImages()) > 0) {
                    // VML Drawings
