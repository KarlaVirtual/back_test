...
//      }
    ...
    {
        // cols
        if (oldCount($pSheet->getColumnDimensions()) > 0) {
    ...
    private function writeDataValidations(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
    {
        ...
        if (!empty($dataValidationCollection)) {
            ...
            $objWriter->writeAttribute('count', oldCount($dataValidationCollection));
    ...
    {
        if (oldCount($pSheet->getProtectedCells()) > 0) {
            // protectedRanges
    ...
    {
        if (oldCount($pSheet->getMergeCells()) > 0) {
            // mergeCells
    ...
    private function writeBreaks(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
    {
        ...
        if (!empty($aRowBreaks)) {
            ...
            $objWriter->writeAttribute('count', oldCount($aRowBreaks));
            $objWriter->writeAttribute('manualBreakCount', oldCount($aRowBreaks));
        ...
        if (!empty($aColumnBreaks)) {
            ...
            $objWriter->writeAttribute('count', oldCount($aColumnBreaks));
            $objWriter->writeAttribute('manualBreakCount', oldCount($aColumnBreaks));
...
//                                $calculatedValue = $pCell->getCalculatedValue();
    ...
    private function writeLegacyDrawing(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
    {
        ...
        if (oldCount($pSheet->getComments()) > 0) {
    ...
    private function writeLegacyDrawingHF(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
    {
        ...
        if (oldCount($pSheet->getHeaderFooter()->getImages()) > 0) {
