...
namespace Backend\imports\PHPExcel;

use PHPExcel_Calculation;
use PHPExcel_DocumentProperties;
use PHPExcel_DocumentSecurity;
use PHPExcel_Style;
...
class PHPExcel
{
    ...
    */
    ...
    {
        $worksheetCount = oldCount($this->workSheetCollection);
    ...
    public function removeSheetByIndex($pIndex = 0)
    {
        ...
        $numSheets = oldCount($this->workSheetCollection);
        ...
        if (($this->activeSheetIndex >= $pIndex) &&
            ($pIndex > oldCount($this->workSheetCollection) - 1)) {
            --$this->activeSheetIndex;
        }
    ...
    {
        return oldCount($this->workSheetCollection);
    }
    ...
    public function addExternalSheet(PHPExcel_Worksheet $pSheet, $iSheetIndex = null)
    {
        ...
        $countCellXfs = oldCount($this->cellXfCollection);
    ...
    public function addCellXf(PHPExcel_Style $style)
    {
        ...
        $style->setIndex(oldCount($this->cellXfCollection) - 1);
    }
    ...
    {
        if ($pIndex > oldCount($this->cellXfCollection) - 1) {
    ...
    public function addCellStyleXf(PHPExcel_Style $pStyle)
    {
        ...
        $pStyle->setIndex(oldCount($this->cellStyleXfCollection) - 1);
    }
    ...
    {
        if ($pIndex > oldCount($this->cellStyleXfCollection) - 1) {
