...
class AstroPayStreamline {
    ...
    private $x_login = 'IenPzTGljm';
    private $x_trans_key = 'BCSZgHAJGp';

    private $x_login_for_webpaystatus = 'MqmGeGLVPn';
    private $x_trans_key_for_webpaystatus = 'mIcEEFIzzF';

    private $secret_key = 'pKtgHeKxuWIfjpdSRGwvjedkuqbzFBNkh';
	...
	public function __construct(){
		...
		if ($this->sandbox){
			$this->url['newinvoice'] = 'https://api-stg.directa24.com/api_curl/streamline/NewInvoice';
