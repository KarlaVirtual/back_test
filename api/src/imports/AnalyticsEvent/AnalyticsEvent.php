<?php
namespace Backend\imports\AnalyticsEvent;
...
class AnalyticsEvent
{
     ...
     */
    private $_useragent = 'PHPAnalyticsAgent/0.1 ()';
     ...
     * @return bool success
     */
    public function trackEvent($object, $action, $label = '', $value = 1,$varcampname='',$varcampsource='',$varcampmedium='')
    {
        ...
        $urchin_params = ''
            ...
            .'&utmcn=' . $varcampname   // Account code
            .'&utmcs=' . $varcampsource   // Account code
            .'&utmcm=' . $varcampmedium   // Account code
            ...
            . '.2.2.utmccn%3D'.$varcampname.'%7Cutmcsr%3D'.$varcampsource.''
            . '%7Cutmcmd%3D'.$varcampmedium.'%3B%2B__utmv%3D'
