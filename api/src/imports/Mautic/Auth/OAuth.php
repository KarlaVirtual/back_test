...
namespace Backend\imports\Mautic\Auth;

use Backend\imports\Mautic\Exception\AuthorizationRequiredException;
use Backend\imports\Mautic\Exception\IncorrectParametersReturnedException;
