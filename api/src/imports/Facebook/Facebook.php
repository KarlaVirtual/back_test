 ...
 *
 */
namespace Backend\imports\Facebook;

use Backend\imports\Facebook\Authentication\AccessToken;
use Backend\imports\Facebook\Authentication\OAuth2Client;
use Backend\imports\Facebook\FileUpload\FacebookFile;
use Backend\imports\Facebook\FileUpload\FacebookResumableUploader;
use Backend\imports\Facebook\FileUpload\FacebookTransferChunk;
use Backend\imports\Facebook\FileUpload\FacebookVideo;
use Backend\imports\Facebook\GraphNodes\GraphEdge;
use Backend\imports\Facebook\Url\UrlDetectionInterface;
use Backend\imports\Facebook\Url\FacebookUrlDetectionHandler;
use Backend\imports\Facebook\PseudoRandomString\PseudoRandomStringGeneratorFactory;
use Backend\imports\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface;
use Backend\imports\Facebook\HttpClients\HttpClientsFactory;
use Backend\imports\Facebook\PersistentData\PersistentDataFactory;
use Backend\imports\Facebook\PersistentData\PersistentDataInterface;
use Backend\imports\Facebook\Helpers\FacebookCanvasHelper;
use Backend\imports\Facebook\Helpers\FacebookJavaScriptHelper;
use Backend\imports\Facebook\Helpers\FacebookPageTabHelper;
use Backend\imports\Facebook\Helpers\FacebookRedirectLoginHelper;
...
class Facebook
{
    ...
    public function getPaginationResults(GraphEdge $graphEdge, $direction)
    {
        ...
        return oldCount($graphEdge) > 0 ? $graphEdge : null;
    }
