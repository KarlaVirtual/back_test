 ...
 *
 */
namespace Backend\imports\Facebook\GraphNodes;

use Backend\imports\Facebook\FacebookResponse;
...
class GraphNodeFactory
{
     ...
     */
    const BASE_GRAPH_NODE_CLASS = 'Backend\imports\Facebook\GraphNodes\GraphNode';

    /**
     * @const string The base graph edge class.
     */
    const BASE_GRAPH_EDGE_CLASS = 'Backend\imports\Facebook\GraphNodes\GraphEdge';

    /**
     * @const string The graph object prefix.
     */
    const BASE_GRAPH_OBJECT_PREFIX = 'Backend\imports\Facebook\GraphNodes\\';
    ...
    public static function isCastableAsGraphEdge(array $data)
    {
        ...
        return array_keys($data) === range(0, oldCount($data) - 1);
    }
