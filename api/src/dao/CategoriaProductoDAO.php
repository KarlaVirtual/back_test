...
/**
 * Interfaz para el modelo o tabla 'CategoriaProducto'.
 *
...
interface CategoriaProductoDAO{
	...
	/**
 	 ...
 	 * la columna CategoriaId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value CategoriaId requerido
 	 */
