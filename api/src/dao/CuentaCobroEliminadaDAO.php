...
/**
 * Interfaz para el modelo o tabla 'CuentaCobroEliminada'.
 *
 ...
 * @since       No definida
 */
interface CuentaCobroEliminadaDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String cuentaCobroEliminada cuentaCobroEliminada
 	 */
	...
	/**
 	 ...
 	 * la columna FechaCuenta sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value FechaCuenta requerido
 	 */	
