...
/**
 * Interfaz para el modelo o tabla 'IntEventoApuestaDetalle'.
 *
 ...
 * @since       No definida
 */
interface IntEventoApuestaDetalleDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String intEventoApuestaDetalle intEventoApuestaDetalle
 	 */
	...
	/**
 	 ...
 	 * la columna EventoapuestaId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value EventoapuestaId requerido
 	 */	
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna EstadoApuesta sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value EstadoApuesta requerido
 	 */	
