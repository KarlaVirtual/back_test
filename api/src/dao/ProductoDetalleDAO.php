...
/**
 * Interfaz para el modelo o tabla 'ProductoDetalle'.
 *
...
interface ProductoDetalleDAO{
	...
	/**
 	 ...
 	 *
 	 * @param productoDetalle productoDetalle
 	 */
	...
	/**
 	 ...
 	 * la columna ProductoI sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value ProductoI requerido
 	 */	
