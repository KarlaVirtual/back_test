 ...
 * @since       No definida
 */
interface IntApuestaDetalleDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String intApuestaDetalle intApuestaDetalle
 	 */
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna OpcionId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value OpcionId requerido
 	 */	
