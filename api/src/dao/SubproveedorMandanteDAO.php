...
/**
 * Interfaz para el modelo o tabla 'SubproveedorMandante'.
 *
 ...
 * @since       No definida
 */
interface SubproveedorMandanteDAO{
	...
	/**
 	 ...
 	 * la columna Subproveedor sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value Subproveedor requerido
 	 */	
