...
/**
 * Interfaz para el modelo o tabla 'UsuarioAutomation'.
 *
 ...
 * @since       No definida
 */
interface UsuarioAutomation2DAO{
	...
	/**
 	 ...
 	 *
 	 * @param String usuariobono usuariobono
 	 */
	public function insert($usuariobono);
	
	/**
 	 * Editar un registro en la base de datos
 	 *
 	 * @param Object usuariobono usuariobono
 	 */
