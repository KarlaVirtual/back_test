...
/**
 * Interfaz para el modelo o tabla 'IntEvento'.
 *
...
interface IntEventoDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String intEvento intEvento
 	 */
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna ApuestaEstado sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value ApuestaEstado requerido
 	 */	
