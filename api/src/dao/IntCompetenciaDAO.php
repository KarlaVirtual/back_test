...
/**
 * Interfaz para el modelo o tabla 'IntCompetencia'.
 *
...
interface IntCompetenciaDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String intCompetencia intCompetencia
 	 */
	...
	/**
 	 ...
 	 * la columna RegionId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value RegionId requerido
 	 */	
