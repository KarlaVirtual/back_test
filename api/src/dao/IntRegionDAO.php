...
/**
 * Interfaz para el modelo o tabla 'IntRegion'.
 *
...
interface IntRegionDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String intRegion intRegion
 	 */
	...
	/**
 	 ...
 	 * la columna DeporteId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value DeporteId requerido
 	 */	
