...
/**
 * Interfaz para el modelo o tabla 'Perfil'.
 *
...
interface PerfilDAO{
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna DiasClave sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value DiasClave requerido
 	 */
	...
	/**
 	 * Eliminar todos los registros donde se encuentre que
 	 * la columna ApuestaMi sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value ApuestaMi requerido
 	 */	
