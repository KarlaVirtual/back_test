...
/**
 * Interfaz para el modelo o tabla 'UsumarketingResumen'.
 *
 ...
 * @since       No definida
 */
interface UsumarketingResumenDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String $usumarketing_id llave primaria
 	 */
	...
	/**
 	 ...
 	 *
 	 * @param String usuariocomision usuariocomision
 	 */
	...
	/**
 	 ...
 	 *
 	 * @param Object usuariocomision usuariocomision
 	 */
