...
/**
 * Interfaz para el modelo o tabla 'Banner'.
 *
...
interface BannerDAO{
	...
	/**
 	 * Eliminar todos los registros donde se encuentre que
 	 * la columna UsucreId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value UsucreId requerido
 	 */
