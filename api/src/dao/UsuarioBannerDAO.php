...
/**
 * Interfaz para el modelo o tabla 'UsuarioBanner'.
 *
...
interface UsuarioBannerDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String $usubanner_id llave primaria
 	 */
	public function delete($usubanner_id);
	...
	/**
 	 ...
 	 */
	public function insert($usuariobanner);
