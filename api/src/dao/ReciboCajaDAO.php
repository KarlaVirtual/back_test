...
interface ReciboCajaDAO{
	...
	/**
 	 ...
 	 *
 	 * @param String reciboCaja reciboCaja
 	 */
	...
	/**
 	 ...
 	 *
 	 * @param Object reciboCaja reciboCaja
 	 */
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna DepositanteId sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value DepositanteId requerido
 	 */	
