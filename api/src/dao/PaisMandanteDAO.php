...
/**
 * Interfaz para el modelo o tabla 'PaisMandante'.
 *
...
interface PaisMandanteDAO{
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna PaisMandanteNom sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value PaisMandanteNom requerido
 	 */	
