...
/**
 * Interfaz para el modelo o tabla 'Sesiones'.
 *
...
interface SesionesDAO{
	...
	/**
 	 * Obtener todos los registros donde se encuentre que
 	 * la columna ClaveSesion sea igual al valor pasado como parámetro
 	 *
	...
	/**
 	 ...
 	 * la columna ClaveSesion sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value ClaveSesion requerido
 	 */	
