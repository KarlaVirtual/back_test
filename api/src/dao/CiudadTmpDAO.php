...
/**
 * Interfaz para el modelo o tabla 'CiudadTmp'.
 *
...
interface CiudadTmpDAO{
	...
	/**
 	 ...
 	 *
 	 * @param Object ciudadTmp ciudadTmp
 	 */
	...
	/**
 	 ...
 	 * la columna CiudadCod sea igual al valor pasado como parámetro
 	 *
 	 * @param String $value CiudadCod requerido
 	 */
