...
trait RedisConnectionTrait2
{
     ...
     */
    public static function getRedisInstance($enabled=false,$redisHost = 'tlsv1.2://amaaaaaafe5qyeqaqsntnxjnk5mruvuaqvotv63u6hsc7fd6hmxkj2j7kwjq-p.redis.us-ashburn-1.oci.oraclecloud.com', $redisPort = 6379, $pass = 'Mwtm7Gea@R8jnuJDd4XVcrA')
    {
