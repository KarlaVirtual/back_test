...
use Backend\dao\CompetenciaDAO;
use Backend\dto\Competencia;
use Backend\sql\QueryExecutor;
use Backend\sql\SqlQuery;
use Backend\sql\Transaction;
/** 
* Clase 'CompetenciaMySqlDAO'
* 
* Esta clase provee las consultas del modelo o tabla 'Competencia'
* 
* Ejemplo de uso: 
...
* 
*/
class CompetenciaMySqlDAO implements CompetenciaDAO{
    ...
    */
	...
	public function load($id){
		$sql = 'SELECT * FROM competencia WHERE competencia_id = ?';
	...
	public function queryAllOrderBy($orderColumn){
		$sql = 'SELECT * FROM competencia ORDER BY '.$orderColumn;
		$sqlQuery = new SqlQuery($sql);
		return $this->getList($sqlQuery);
	}
	...
	public function insert($usuarioConfiguracion){
		$sql = 'INSERT INTO competencia (  descripcion, usucrea_id, usumodif_id,pais_id,mandante) VALUES (  ?, ?, ?, ?, ?)';
		$sqlQuery = new SqlQuery($sql);
        ...
        $sqlQuery->set($usuarioConfiguracion->paisId);
        $sqlQuery->setNumber($usuarioConfiguracion->mandante);

		$id = $this->executeInsert($sqlQuery);	
		$usuarioConfiguracion->paisId = $id;
		return $id;
	}
	...
	public function update($usuarioConfiguracion){
		$sql = 'UPDATE competencia SET  descripcion = ?, usucrea_id = ?, usumodif_id = ?, pais_id = ?, mandante = ? WHERE competencia_id = ?';
		$sqlQuery = new SqlQuery($sql);
    ...
    *
    */
    public function queryCompetenciaCustom($select, $sidx, $sord, $start, $limit, $filters, $searchOn)
    {
        ...
        $sql = 'SELECT count(*) count FROM competencia LEFT OUTER JOIN pais ON (pais.pais_id = competencia.pais_id) ' . $where;
        ...
        $sql = 'SELECT ' .$select .'  FROM competencia LEFT OUTER JOIN pais ON (pais.pais_id = competencia.pais_id) ' . $where . " order by " . $sidx . " " . $sord . " LIMIT " . $start . " , " . $limit;
	...
	public function queryByUsucreaId($value){
		$sql = 'SELECT * FROM competencia WHERE usucrea_id = ?';
		$sqlQuery = new SqlQuery($sql);
	...
	public function queryByUsumodifId($value){
		$sql = 'SELECT * FROM competencia WHERE usumodif_id = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByFechaCrea($value){
		$sql = 'SELECT * FROM competencia WHERE fecha_crea = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
	...
	public function queryByFechaModif($value){
		$sql = 'SELECT * FROM competencia WHERE fecha_modif = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->getList($sqlQuery);
	}
    ...
    public function queryByUsuarioIdAndTipoAndEstado($competenciaId,$nombre,$estado){
        $sql = 'SELECT * FROM competencia WHERE competencia_id = ? AND nombre=? AND estado = ?';
        $sqlQuery = new SqlQuery($sql);
        $sqlQuery->set($competenciaId);
        $sqlQuery->set($nombre);
        $sqlQuery->set($estadosss);
        return $this->getList($sqlQuery);
    }
    ...
    public function queryByUsuarioIdAndTipoAndProductoIdAndEstado($competenciaId,$nombre,$longitud,$estado){
        $sql = 'SELECT * FROM competencia WHERE competencia_id = ? AND nombre=? AND longitud=? AND estado = ?';
        $sqlQuery = new SqlQuery($sql);
        $sqlQuery->set($competenciaId);
        $sqlQuery->set($nombre);
	...
	public function deleteByNombre($value){
		$sql = 'DELETE FROM competencia WHERE competenciaId = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByUsucreaId($value){
		$sql = 'DELETE FROM competencia WHERE usucrea_id = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByUsumodifId($value){
		$sql = 'DELETE FROM competencia WHERE usumodif_id = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->setNumber($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByFechaCrea($value){
		$sql = 'DELETE FROM competencia WHERE fecha_crea = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
	...
	public function deleteByFechaModif($value){
		$sql = 'DELETE FROM competencia WHERE fecha_modif = ?';
		$sqlQuery = new SqlQuery($sql);
		$sqlQuery->set($value);
		return $this->executeUpdate($sqlQuery);
	}
     ...
     *
     * @return Object $competencia Competencia
     *
     * @access protected
     *
     */
	protected function readRow($row){
		$usuarioConfiguracion = new Competencia();
		
		$usuarioConfiguracion->paisId = $row['pais_id'];
        ...
        $usuarioConfiguracion->mandante = $row['mandante'];
