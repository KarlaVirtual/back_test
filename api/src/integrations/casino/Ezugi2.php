...
/**
 * Clase Ezugi para la integración con el sistema de casino.
 *
 * Esta clase contiene métodos para manejar transacciones de débito, crédito y rollback,
 * así como la autenticación de usuarios en el sistema de casino.
 * Se conecta con diferentes entidades como Proveedor, Usuario, Mandante, y realiza
 * operaciones en la base de datos a través de DAOs.
 *
 * @category   Red
 * @package    API
 ...
 * Clase Ezugi.
 *
 * Esta clase maneja la integración con el sistema de casino Ezugi,
 * proporcionando métodos para realizar transacciones de débito, crédito y rollback.
 */
class Ezugi2
{
    /**
    ...
    public function __construct($operadorId, $token, $uid = "")
    {
        ...
        $this->operadorId = 10178001; // Valor fijo para pruebas.
        $this->token = $token;
        $this->uid = $uid;
    }
    ...
    /**
     * Autentica al usuario utilizando el token proporcionado.
     *
     * @return string Respuesta en formato JSON con los datos del usuario o un error.
     * @throws Exception Si el token está vacío o no es válido.
     */
     ...
     * @param integer $serverId      ID del servidor.
     ...
     * @param ineger  $serverId       ID del servidor.
     * @param string  $roundId        ID de la ronda.
     * @param string  $transactionId  ID de la transacción.
     * @param integer $seatId         ID del asiento.
     * @param string  $gameDataString Datos del juego.
