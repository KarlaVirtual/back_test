<?php
/**
 * Clase PATAGONIASERVICES
 *
 * Esta clase proporciona servicios de integración con la plataforma de juegos Patagonia.
...
/**
 * Clase que proporciona servicios de integración con la plataforma de juegos Patagonia.
 */
class PATAGONIASERVICES
{
    /**
     * Representación de 'URLREDIRECTION'
     *
     * @var string
     * @access private
     */
