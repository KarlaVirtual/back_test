...
/**
 * WinningData Class Doc Comment
 *
 * @category    Class
 * @description Total amount that system will pay to ticket owner for this system bet. Rule to pay: - maxWinning + bonus &lt; maxPayout ? maxWinning + bonus : maxPayout
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class WinningData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Winning Data';
    ...
    /**
     * Sets min_winning
     * @param double $min_winning Potencial total min amount (without bonus) that ticket owner could win for this systembet if he win n-combination bets.
     * @return $this
     */
    ...
    /**
     * Sets max_winning
     * @param double $max_winning Potencial total max amount (without bonus) that ticket owner could win for this systembet if he win all your bets.
     * @return $this
     */
    ...
    /**
     * Sets min_bonus
     * @param double $min_bonus Min Bonus is a percentage of minWinning to add to minWinning for this systembet. This bonus is calculated using bonus field LimitsSetting Entity. The total systembet amount to win is calculated minWinning + minbonus.
     * @return $this
     */
    ...
    /**
     * Sets max_bonus
     * @param double $max_bonus Max Bonus is a percentage of maxWinning to add to maxWinning for this systembet. This bonus is calculated using bonus field LimitsSetting Entity. The total systembet amount to win is calculated maxWinning + bonus.
     * @return $this
     */
