 ...
 * Clase Playngo
 *
 * Esta clase maneja la integración con el proveedor de juegos Play'n GO.
 * Proporciona métodos para autenticación, balance, débito, crédito y rollback de transacciones.
 *
...
class Playngo
{
     ...
     * @var string
     */
    private $signOriginal = "stagestagestagestage";
     ...
     * @var string
     */
    private $signOriginalDEV = "yryUXrbbkAYoGOAsVFXZJmogm";
    ...
    /**
     * Datos asociados a la transacción actual.
     *
     * @var mixed
     */
    private $data;
    ...
    /**
     * Identificador externo del usuario o transacción.
     *
     * @var string
     */
    private $externalId;
     ...
     *
     * Inicializa el objeto con el token, uid y externalId.
     * Valida la firma del entorno de producción.
     *
     * @param string $token      Token de autenticación.
     * @param string $uid        Identificador único del usuario (opcional).
     * @param string $externalId Identificador externo del usuario o transacción (opcional).
     */
     ...
     * Método Auth
     *
     * Autentica al usuario con el proveedor Play'n GO.
     * Retorna un XML con los datos del usuario autenticado.
     *
     * @return string XML con los datos de autenticación.
     * @throws Exception Si el token o externalId están vacíos.
     */
     ...
     * Método Debit
     *
     * Realiza un débito en la cuenta del usuario para un juego específico.
     *
     * @param string $gameId        Identificador del juego.
     ...
     * Método Credit
     *
     * Realiza un crédito en la cuenta del usuario para un juego específico.
     *
     * @param string  $gameId        Identificador del juego.
     * @param string  $ticketId      Identificador del ticket.
     * @param string  $uid           Identificador único del usuario.
     ...
     * Método convertError
     *
     * Convierte un error en un XML con el formato esperado por el proveedor.
     *
     * @param integer $code    Código del error.
     * @param string  $message Mensaje del error.
     *
     * @return string XML con el error convertido.
     */
