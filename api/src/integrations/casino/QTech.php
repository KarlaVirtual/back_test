...
/**
 * Clase QTech para la integración con el proveedor QTECH.
 *
 * Esta clase contiene métodos para manejar transacciones de débito, crédito, rollback,
 * autenticación y consulta de saldo, entre otros. También incluye manejo de errores
 * específicos del proveedor y validaciones relacionadas con usuarios, mandantes y productos.
 *
 ...
 * Clase QTech.
 *
 * Esta clase maneja la integración con el proveedor QTECH, proporcionando métodos
 * para realizar transacciones como débito, crédito, rollback, autenticación y consulta de saldo.
 */
class QTech
{
    /**
    ...
    /**
     * Firma para validar las transacciones.
     *
     * @var string
     */
    private $sign;
     ...
     * @var string
     */
    private $signOriginalDEV = "D0rad0DEV";
    ...
    /**
     * Constructor de la clase QTech.
     *
     * @param string $token Token de autenticación.
     * @param string $sign  Firma para validar las transacciones.
     */
    ...
    /**
     * Autentica al usuario y valida el token y la firma.
     *
     * @return string JSON con el balance y la moneda del usuario autenticado.
     * @throws Exception Si la firma o el token son inválidos.
     */
     ...
     *
     * @param string $userid Opcional ID del usuario.
     *
     ...
     *
     * @return string JSON con el balance actualizado y el ID de referencia.
    ...
    public function Debit($gameId, $debitAmount, $roundId, $transactionId, $datos)
    {
        ...
        try {
            ...
            /*  Obtenemos el Proveedor con el abreviado QTECH */
            $Proveedor = new Proveedor("", "QTECH");
            ...
            $this->transaccionApi->setIdentificador($roundId . "QTECH");
            ...
            $TransaccionJuego->setTicketId($roundId . "QTECH");
            ...
            if ($TransaccionJuego->existsTicketId()) {
                $this->roundIdSuper = $roundId . "QTECH";
            ...
            if ($Mandante->propio == "S") {
                ...
                if ($Transaction->isIsconnected()) {
                    ...
                    if ($ExisteTicket) {
                        ...
                        $TransaccionJuego = new TransaccionJuego("", $roundId . "QTECH", "");
     ...
     *
     * @return string JSON con el balance actualizado y el ID de referencia.
     * @throws Exception Si ocurre un error en el rollback.
     */
    ...
    /**
     * Verifica un parámetro y retorna información básica.
     *
     * @param mixed $param Parámetro a verificar.
     *
     * @return string JSON con el nodo, el parámetro y la firma.
     */
     ...
     *
     * @return string Respuesta JSON con el código y mensaje del error.
     */
    public function convertError($code, $message)
    {
        ...
        switch ($code) {
            case 10011:
                ...
                $messageProveedor = "The given wallet session token has expired.";
            ...
            case 10001:
                ...
                $this->transaccionApi->setValor($TransaccionApi->getValor());


                $response = (array)json_decode($TransaccionApi->getRespuesta());
            ...
            case 20001:
                $codeProveedor = "INSUFFICIENT_FUNDS";
                $messageProveedor = "Not enough funds for the debit operation";
                http_response_code(400);
                break;

            case 20002:
                $codeProveedor = "LOGIN_FAILED";
                $messageProveedor = "The given pass-key is incorrect";
