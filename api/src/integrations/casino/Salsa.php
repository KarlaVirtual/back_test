 ...
 * Clase Salsa
 *
 * Esta clase implementa la integración con el proveedor de casino Salsa (PTG).
    ...
    public function Auth()
    {
        ...
        try {
            ...
            if ($Mandante->propio == "S") {
                ...
                $Registration->addAttribute('Value', date('Y-m-d', strtotime($UsuarioMandante->fechaCrea)));
