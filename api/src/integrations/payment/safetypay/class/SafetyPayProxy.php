<?php
namespace Backend\Integrations\payment\safetypay;
...
if(!@include(__DIR__."/../lib/nanolink-sha256.inc.php"))
	require_once __DIR__.'/./lib/nanolink-sha256.inc.php';
if(!@include(__DIR__."/../lib/simplexml.class.php"))
	require_once __DIR__.'/./lib/simplexml.class.php';

require_once __DIR__.'/SafetyPayWSDL.inc.php';
...
class SafetyPayProxy
{
     ...
     * Set default values.
     */
    function __construct($apiKeyP="",$SignatureKey ="",$Environment ="")
    {
        /*
       ...
       // $this->conf['ApiKey'] = '34d44f4647a4c84b24fc597621bddb15';
       // $this->conf['SignatureKey'] = '109909709964625b4a392dbfd7b62251';


        // Credenciales Productiva
        $this->conf['ApiKey'] = '90efdf1baa14f86ad359ed9e1ac4a9f5';
        $this->conf['SignatureKey'] = 'c08a1ed0fa544fa9a7c8152c7e0ad578';
         ...
         * 0: For Production
         */
        $this->conf['Environment'] = 0;



        if($apiKeyP != "" ){
            $this->conf['ApiKey'] = $apiKeyP;
        }

        if($SignatureKey != "" ){
            $this->conf['SignatureKey'] = $SignatureKey;
        }

        if($Environment != "" ){
            $this->conf['Environment'] = $Environment;
        }
         ...
         * Reverse Amount
         */        
        $this->conf['SalesCurrencyCode'] = 'PEN';
    ...
    function setAccessPoint()
    {
        ...
        if ( $this->conf['Environment'] )
            $domain_srv = 'sandbox-mws2.safetypay.com';
