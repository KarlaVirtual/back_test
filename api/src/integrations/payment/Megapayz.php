...
/**
 * Clase Megapayz para manejar integraciones de pagos con el proveedor Megapayz.
 *
 * Este archivo contiene la implementación de la clase Megapayz, que permite
 ...
 * Clase Megapayz.
 *
 * Esta clase maneja la integración con el proveedor de pagos Megapayz,
...
class Megapayz
{
    ...
    /**
     * Constructor de la clase Megapayz.
     *
    ...
    public function confirmation($t_value)
    {
        ...
        switch ($this->status) {
            case "PROGRESS":
                ...
                $comentario = 'Pendiente por Megapayz';
            ...
            case "SUCCESS":
                ...
                // Comentario personalizado para el log
                $comentario = 'Aprobada por Megapayz';
            ...
            case "CANCEL":
                ...
                // Comentario personalizado para el log
                $comentario = 'Rechazada por Megapayz';
