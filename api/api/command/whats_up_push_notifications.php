...
function getTypeWards($type)
{
    ...
    /* Crea un arreglo vacío para almacenar mensajes en una estructura de respuesta. */
$response = array();
...
$response["data"] = array(
    ...
    /* organiza datos en un array de respuesta para una aplicación. */
$response["data"] = array(
);


    /* asigna un código de respuesta y un identificador desde un objeto JSON. */
$response["code"] = 0;
