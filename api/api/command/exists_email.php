 ...
 * @param string $json->params->ck Cookie de sesión.
 * @param string $json->params->site_id Sitio del mandante.
 * @param string $json->params->email Email a verificar.
 *
 * @return array
 ...
 *
 * @throws Exception
 *   - 19001 El email ya esta registrado.
 */

// Recupera el valor de la cookie desde los parámetros JSON.
...
// Arreglo de caracteres no deseados y sus respectivas sustituciones.
...
/**
 * Transforma los caracteres no deseados de un correo electrónico y depura el identificador del sitio.
 *
 * Este código utiliza un array de sustitución para reemplazar caracteres especiales y mejorar la
 * compatibilidad del correo electrónico. Luego, se ejecuta una función para depurar el identificador del sitio.
 * Si el identificador del sitio queda vacío tras la depuración, se lanza una excepción.
 */
...
// Crea una instancia de la clase Mandante utilizando el site_id proporcionado
...
// Prepara la respuesta en formato de array
$response = array();
$response["code"] = 0;
