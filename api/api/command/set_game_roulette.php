...
/* gestiona un juego de ruleta, añadiendo un ganador a la sesión. */
if (true) {
    ...
    $winner = $RuletaInterna->agregarPremioRuleta($usuruletaId, $UsuarioMandante);
