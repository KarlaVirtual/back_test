...
/* captura el valor de "id" de las solicitudes HTTP en PHP. */
$Id = $_REQUEST["id"];
...
if (is_numeric($Id)) {
    ...
    /* Inicializa variables y obtiene objetos de la base de datos mediante un DAO. */
    $final = [];
    $totalm = 0;
    $cont = 0;
    ...
    foreach ($objects as $object) {
        ...
        /* Crea un arreglo asociativo con propiedades de un objeto específico. */
        $array = [];
        ...
        /* traduce descripciones al inglés si el idioma de sesión es inglés. */
        ...
        /* Agrega elementos de un array al final de otro en PHP. */
