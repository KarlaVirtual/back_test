 ...
 * 
 * Obtiene los posibles estados que puede tener un documento en el sistema
 *
 * @return array {
 *   "HasError": boolean,
 *   "AlertType": string,
 ...
 * 
 * Donde:
 * - HasError: Indica si hubo error en la operación
 * - AlertType: Tipo de alerta (success, error, etc)
 * - AlertMessage: Mensaje descriptivo
 * - ModelErrors: Array con errores de validación
 * - Data: Array con los estados posibles:
 *   - NumId: Identificador del estado (A: Aprobado, R: Rechazado, E: Enviado)
