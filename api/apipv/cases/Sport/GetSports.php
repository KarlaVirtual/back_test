 ...
 * Obtener deportes
 *
 * @param string $URI URI de la solicitud que contiene los parámetros.
 * @param array $_REQUEST Arreglo con los siguientes atributos:
 * @param $_REQUEST["BeginDate"] Fecha de inicio para filtrar deportes.
 * @param $_REQUEST["EndDate"] Fecha de fin para filtrar deportes.
 * 
 *
 ...
 *  - array $Data Datos de los deportes obtenidos.
 *
 * @throws Exception Si ocurre un error durante la operación.
 */


/* separa una URI y cuenta elementos de un array generado. */
$obj = (explode("/", current(explode("?", $URI))));
$count = oldCount($obj);
switch ($obj[$count - 2] . "/" . $obj[$count - 1]) {
    case "Sport/GetSports":
        /* Obtiene deportes entre fechas y genera una respuesta con el resultado. */

        $BeginDate = $_REQUEST["BeginDate"];
        $EndDate = $_REQUEST["EndDate"];
        $sports = (new ConfigurationEnvironment())->getSports($BeginDate, $EndDate);
    ...
    case "OddsFeed/GetSports":
        ...
        /* Se procesa un JSON para obtener datos de deportes personalizados y los decodifica. */
        ...
        /* crea un arreglo final con datos de deportes seleccionados. */
        $final = array();
        ...
        /* Código que prepara una respuesta indicando éxito en una operación realizada. */
        $response["Data"] = $final;
        ...
        /* Inicializa un arreglo vacío para almacenar errores relacionados con el modelo. */
        $response["ModelErrors"] = [];
