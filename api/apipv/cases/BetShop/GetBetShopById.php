...
/**
 * Obtiene la información de un punto de venta basándose en el ID proporcionado.
 *
 * @param string $params JSON codificado que contiene los datos de la solicitud, incluyendo:
 * @param int $params ->Id Identificador del punto de venta.
 *
 ...
 *                         - Data (array): Información del punto de venta, incluyendo:
...
/* obtiene y decodifica datos JSON, luego inicializa un objeto Mandante. */
...
/* establece límites de filas y genera una consulta JSON para obtener datos. */
if ($MaxRows == "") {
    $MaxRows = 100000;
}
...
/* Convierte datos JSON a un arreglo, extrayendo información específica de cada elemento. */
...
/* define una respuesta estructurada para una operación exitosa, sin errores. */
