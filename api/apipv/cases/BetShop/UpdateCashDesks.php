 ...
 *
 * Actualiza la información de un usuario en la base de datos si es válido.
 *
 * @param object $params Objeto que contiene los parámetros necesarios:
 * @param int $param ->FromId ID del usuario a actualizar.
 * @param string $param ->Name Nuevo nombre del usuario.
 *
...
if ($FromId != "" && is_numeric($FromId)) {
    ...
    /* maneja un error, configurando mensajes de alerta y estado de respuesta. */
