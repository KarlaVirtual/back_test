 ...
 *   - UserName: string Nombre de usuario del agente.
 *   - SystemName: int Nombre del sistema.
 *   - IsSuspended: boolean Indica si el agente está suspendido.
 *   - FirstName: string Nombre del agente.
 *   - LastName: string Apellido del agente.
 *   - Phone: string Teléfono del agente.
 *   - LastLoginLocalDate: string Fecha del último inicio de sesión.
 *   - LastLoginIp: string IP del último inicio de sesión.
 *   - CurrencyId: int ID de la moneda.
 *   - Address: string Dirección del agente.
 *   - Email: string Correo electrónico del agente.
 *   - CashBalance: float Saldo en efectivo del agente.
 *   - UserId: int ID del usuario.
 *
 * @throws Exception Si no hay saldo para transferir.
 */

/* obtiene datos JSON y asigna un ID de usuario en PHP. */
...
/* asigna valores y obtiene detalles de un usuario administrador. */
$Usuario->mandante = 0;
...
/* crea un array con información del agente, incluyendo su estado. */
$array = [];
...
/* asigna datos de un agente a un arreglo asociativo en PHP. */
...
/* Se asignan datos de un agente a un array para su uso posterior. */
...
/* Código que configura una respuesta exitosa sin errores y con datos de usuarios. */
