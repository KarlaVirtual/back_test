 ...
 *
 * Obtener detalles del grupo de un agente mediante un ID.
 *
 ...
 *                           - int $response['Data']['Id'] ID del grupo.
 *                           - bool $response['Data']['IsDefault'] Indica si es el grupo por defecto.
 *                           - string $response['Data']['Name'] Nombre del grupo.
 *                           - int $response['Data']['OwnerId'] ID del propietario.
 *                           - int $response['Data']['Type'] Tipo de grupo.
 *                           - int $response['Data']['Value'] Valor del grupo.
 */



/* Código que genera una respuesta exitosa con datos de una operación completada. */
