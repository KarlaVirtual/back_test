 ...
 *
 * Obtener la publicidad de la maquina
 *
 * @param no
 *
 * @return
...
if ($FromId != "" || $id != "") {
    ...
    /* Inicializa un objeto y establece filas máximas y de inicio para paginación. */
    ...
    /* Se construye una lista de reglas para filtrar usuarios por ID. */
    $rules = [];
    ...
    /* Se codifican reglas en JSON y se obtienen publicidades de usuario personalizadas. */
    ...
    /* Transforma datos de usuario publicidad en un array estructurado para uso posterior. */
    $final = [];
    ...
    /* Código que estructura una respuesta sin errores y con datos finales. */
    ...
    /* almacena información de respuesta sobre filas, conteo y datos finales. */
