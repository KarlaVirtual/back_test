 ...
 * 
 * Obtiene las pasarelas de pago disponibles en el sistema
 *
 * @return array {
 ...
 *   "Data": array {
 *     "Id": int,               // ID de la pasarela de pago
 *     "Name": string           // Nombre de la pasarela de pago
 *   }[]
 * }
 */
// Inicializa el objeto Producto para acceder a los métodos de la clase
$Producto = new Producto();

// Configura los parámetros de paginación para obtener todos los registros
$SkeepRows = 0;
$MaxRows = 1000000;

// Define el filtro JSON para obtener solo las pasarelas de pago (tipo PAYMENT)
$json = '{"rules" : [{"field" : "proveedor.tipo", "data": "PAYMENT","op":"eq"}] ,"groupOp" : "AND"}';

// Obtiene los productos filtrados ordenados por ID
...
// Inicializa el array que contendrá los datos procesados
$final = [];

// Procesa cada producto para extraer solo los campos necesarios
