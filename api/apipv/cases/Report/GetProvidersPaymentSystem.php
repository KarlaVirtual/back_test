...
/**
 * Report/GetProvidersPaymentSystem
 * 
 * Obtiene la lista de proveedores de pasarelas de pago disponibles en el sistema
 *
 * @return array {
 ...
 * }
 */
// Inicializa el objeto Proveedor para acceder a los proveedores
...
// Define el filtro JSON para obtener solo proveedores de tipo PAYMENT
$json = '{"rules" : [{"field" : "proveedor.tipo", "data": "PAYMENT","op":"eq"}] ,"groupOp" : "AND"}';

// Obtiene los proveedores ordenados por ID de forma ascendente
...
// Procesa cada proveedor y extrae su ID y nombre
...
// Asigna los proveedores procesados a la respuesta
$response["Data"] = $final;
