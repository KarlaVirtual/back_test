 ...
 * ft/Sports
 *
 * Deportes/ObtenerLista
 *
 * Recupera una lista de deportes personalizados según los criterios establecidos en el filtro JSON.
 *
 * Este recurso consulta la tabla `int_deporte` y devuelve una lista de deportes con su identificador y nombre.
 *
 * @param bool $isLive : Indica si la consulta debe realizarse en tiempo real (sin impacto en la consulta actual).
 *
 ...
 *  - *Data* (array): Contiene los resultados de la consulta en la estructura:
 *    - *ObjectId* (int): Identificador del deporte.
 *    - *Name* (string): Nombre del deporte.
 *    - *NameId* (string): Identificador del nombre del deporte.
 *
...
/* recibe un parámetro y genera una respuesta de éxito sin errores. */
...
/* Se crea un arreglo vacío y se asigna un JSON con una regla específica. */
$response["Data"] = [];
...
/* Obtiene y procesa datos de deportes en un formato JSON para estructurarlos en un array. */
...
/* Asigna el valor de $final a la clave "Result" en el arreglo $response. */
