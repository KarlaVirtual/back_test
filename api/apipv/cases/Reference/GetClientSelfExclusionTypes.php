 ...
 *
 * Obtener los tipos de autoexclusion
 *
 * @param no
 *
 ...
 *  - *data* (array): Contiene los tipos de autoexclusiones con su numId (2,6) y el nombre (Autoexclusion Total, Autoexclusion Descanso)
 *
...
/* Código PHP que construye una respuesta JSON con información de éxito y datos. */
