 ...
 *
 * Este script obtiene una lista de usuarios administrativos personalizados con base en filtros.
 *
 ...
 * 
 * 
 * @param string $_REQUEST["userId"] ID del usuario administrativo a consultar.
 *
 ...
 *                         - Data (array): Lista de usuarios con información detallada.
 */


/* obtiene un ID de usuario y crea una instancia de la clase Usuario. */
...
/* decodifica un JSON y extrae parámetros específicos para su uso. */
...
/* Inicializa $MaxRows y agrega reglas si $userId no está vacío. */
if ($MaxRows == "") {
    $MaxRows = 1000;
}
...
/* genera un filtro en JSON y obtiene usuarios personalizados. */
...
foreach ($usuarios->data as $key => $value) {
    ...
    /* verifica el estado del usuario y asigna un valor a Islocked. */
    $Islocked = false;
    ...
    /* Se asignan valores a un arreglo asociativo en PHP desde un objeto. */
    ...
    /* inicializa un array con datos de usuario y atributos específicos. */
    ...
    /* Se inicializa un array con valores específicos sobre el estado de un usuario. */
    ...
    /* Se asigna el nombre del usuario a un arreglo y se añade a una lista final. */
...
/* inicializa una respuesta sin errores y asigna datos en formato de array. */
