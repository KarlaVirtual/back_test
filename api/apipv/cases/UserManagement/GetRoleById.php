 ...
 *
 * Este script permite obtener un rol específico basado en su ID.
 *
 ...
 *  - Data (array): Contiene los datos del rol, incluyendo:
 *      - Id (int): ID del rol.
...
/* Se inicializa un objeto "Perfil" y se obtienen parámetros de consulta. */
$Perfil = new Perfil();
...
/* establece un límite de filas y genera una consulta JSON para perfiles. */
if ($MaxRows == "") {
    $MaxRows = 100000;
}
...
/* decodifica un JSON y extrae el primer perfil a un array. */
...
/* obtiene y estructura datos de perfiles de usuario para una consulta. */
...
/* decodifica JSON y obtiene submenús basados en reglas específicas. */
...
/* Decodifica JSON de menús y asigna un conteo a la respuesta. */
...
/* inicializa un arreglo para errores y asigna datos a otra variable. */
