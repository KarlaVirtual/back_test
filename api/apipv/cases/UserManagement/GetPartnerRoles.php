...
/**
 * Obtener roles de partner
 *
 * Este script procesa solicitudes para obtener roles de partner y sus permisos asociados.
 *
 * @param object $params
 ...
 *   - Data: array, información de los roles obtenidos.
 */


/* Creación de un objeto 'Perfil' y manejo de parámetros para filas y orden. */
$Perfil = new Perfil();
...
/* Asignar valores predeterminados a variables si están vacías. */
if ($OrderedItem == "") {
    $OrderedItem = 1;
}
...
/* Se crea un JSON para obtener perfiles personalizados y se decodifica. */
...
foreach ($perfiles->data as $key => $value) {
    ...
    /* Crea un JSON con reglas basadas en datos de un perfil. */
    $array = [];
    ...
    /* Se obtiene un conteo de perfiles de usuario y se decodifica en JSON. */
    ...
    /* Código que genera y procesa un JSON para obtener permisos de submenús. */
...
/* genera una respuesta sin errores con datos y mensajes de éxito. */
