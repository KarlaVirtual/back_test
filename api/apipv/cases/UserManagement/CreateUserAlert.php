 ...
 *
 * Este script permite crear una alerta asociada a un usuario en el sistema.
 *
 * @param object $params Objeto JSON con los siguientes atributos:
 * @param string $params->Action Acción asociada a la alerta.
 * @param int $params->Id Identificador del usuario.
 * @param string $params->State Estado de la alerta ("true" para activo, "false" para inactivo).
 * @param mixed $params->Value Valor asociado a la alerta.
...
/* asigna variables y convierte el estado a "A" si es verdadero. */
...
/* Asignación del valor "I" a la variable $State en caso de no cumplir condiciones previas. */

    $State = "I";
}


/* inserta una nueva alerta de usuario en la base de datos. */
if ($Id >= 0) {
