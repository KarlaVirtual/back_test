 ...
 *
 * Alterna el estado de un usuario en la tabla de alertas entre "Activo" (A) e "Inactivo" (I).
 *
 * Este recurso permite cambiar el estado de un usuario en la gestión de alertas.
 * Si el estado actual es "A", se cambia a "I", y si es "I", se cambia a "A".
 *
 * @param int $Id : Identificador único del usuario en la tabla de alertas.
 *
...
/* Cambia el estado de UsuarioAlerta entre "A" e "I" y actualiza en la base de datos. */
$Id = $params->Id;
