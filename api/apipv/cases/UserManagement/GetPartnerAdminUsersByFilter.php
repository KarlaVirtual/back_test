 ...
 *
 * Obtener usuarios administrativos por filtro
 *
 * Este script procesa solicitudes para obtener usuarios administrativos filtrados por ID de cajero.
 *
 * @param object $params
...
/* recibe datos JSON, los decodifica y obtiene el ID de un cajero. */
...
/* establece un límite de filas y genera un filtro JSON para usuarios. */
if ($MaxRows == "") {
    $MaxRows = 100000;
}
...
/* Se decodifica un JSON de usuarios y se inicializa un arreglo vacío. */
...
foreach ($usuarios->data as $key => $value) {
    ...
    /* Se crea un arreglo con información de un usuario y su permiso de recibo. */
    $array = [];
    ...
    /* Configura si el usuario puede depositar y activar registro según su configuración. */
    ...
    /* verifica permiso y agrega un registro al arreglo final. */
...
/* Código que prepara una respuesta exitosa sin errores y con datos finales. */
