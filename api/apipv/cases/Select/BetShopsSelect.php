...
/**
 * Select/BetShopsSelect
 * 
 * Obtiene la lista de puntos de venta para mostrar en un select
 *
 * @param object $params {
 *   "Filter": string      // Texto para filtrar puntos de venta por nombre
 * }
 *
 * @return array {
 ...
 *     "Objects": array[{    // Lista de puntos de venta
 *       "id": int,         // ID del punto de venta
 *       "value": string    // Nombre del punto de venta
 *     }],
...
// Inicialización de objetos y arreglo de reglas
...
if ($keyword != "" & $keyword != null) {
    ...
    // Configuración de reglas por mandante
    ...
    // Construcción del filtro y obtención de datos
    $filtro = array("rules" => $rules, "groupOp" => "AND");
    $json = json_encode($filtro);

    $puntoventas = $PuntoVenta->getPuntoVentasCustom("punto_venta.usuario_id, punto_venta.descripcion", "punto_venta.puntoventa_id", "asc", $SkeepRows, $MaxRows, $json, true);
