...
/* Se inicializan variables para filtrar y limitar productos en una búsqueda. */
...
if ($keyword != "" & $keyword != null) {
    ...
    /* Se añaden reglas de filtrado para productos y proveedores en un array. */
    ...
    array_push($rules, array("field" => "proveedor.abreviado", "data" => "'PAGOTICO','MERCADOONL'", "op" => "in"));


// Si el usuario esta condicionado por el mandante y no es de Global

    /* Condiciona reglas de acceso basadas en el estado de la sesión y mandantes. */
    ...
    /* Código que genera un filtro JSON y obtiene productos según criterios definidos. */
    ...
    /* Agrupa datos de productos y proveedores en un arreglo final. */
    $final = [];
...
/* Configuración de respuesta JSON para indicar éxito y enviar datos finales. */
...
/* asigna valores a un arreglo de respuesta para datos y conteos. */
