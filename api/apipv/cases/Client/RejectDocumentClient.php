 ...
 *
 * Rechaza el documento de un usuario.
 *
 ...
 *
 * @throws Exception Si ocurre un error durante la actualización del estado del documento.
 */


/* Actualiza el estado de un usuario si su documento no está validado. */
$ClientId = $params->Id;
