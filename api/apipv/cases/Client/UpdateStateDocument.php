 ...
 * @param int $params ->Id Identificador del documento.
 *
...
/* Se inicializa un objeto y se verifica su estado de aprobación. */
$Id = $params->Id;
...
/* Actualiza el estado de aprobación del documento y confirma la transacción sin errores. */
...
/* inicializa un arreglo de respuesta con mensajes y errores de modelo. */
