 ...
 *
 * Este script procesa el pago de solicitudes de depósito.
 *
 * @param array $params Array de objetos que contienen los siguientes valores:
 * @param int $param ->Id Identificador de la solicitud de depósito.
 *
 *
 *
...
/* termina la ejecución y crea un objeto UsuarioMandante con datos de sesión. */
exit();
$UsuarioMandante = new UsuarioMandante($_SESSION['usuario2']);

foreach ($params as $param) {

    /* verifica y aprueba una transacción de producto, generando una respuesta. */
    $Id = $param->Id;
    ...
    if ($TransaccionProducto->getEstadoProducto() == "R") {
        ...
        /* maneja un error al intentar modificar un retiro procesado. */
