...
/**
 * Obtener los tipos de cuentas de un cliente.
 *
 * Este script consulta los tipos de cuentas asociadas a un cliente específico
 * y devuelve los datos en un formato estructurado.
 *
 * @param object $params
 * @param string $params ->CurrencyId ID de la moneda.
 * @param string $params ->Id ID del cliente.
 *
 *
 ...
 *   - Data: array Contiene los tipos de cuentas del cliente y sus balances.
 */


/* recibe y decodifica datos JSON, luego crea un objeto Registro. */
...
/* Respuesta estructurada indicando éxito y detallando tipos de balance y montos. */
