...
foreach ($usuarios->data as $key => $value) {
    ...
    $array["Redirection"] = $value->{"usuario_mensaje.msubject"};
    $array["ClientId"] = $value->{"usuario_mensaje.usuto_id"};
    $array["CountrySelect"] = $value->{"usuario_mensaje.pais_id"};

    $array["DateSend"] = $value->{"usuario_mensaje.fecha_expiracion"};
