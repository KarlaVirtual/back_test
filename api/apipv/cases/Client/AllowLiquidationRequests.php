 ...
 *
 * Aprueba solicitudes de liquidación actualizando el estado de UsucomisionResumen.
 *
 * @param object $params Contiene los siguientes valores:
 *  - int $Id: El ID del UsucomisionResumen que se actualizará.
 *
...
/* Actualiza el estado de UsucomisionResumen de "A" a "P" y guarda cambios. */
$Id = $params->Id;
...
if ($UsucomisionResumen->getEstado() == "A") {
    ...
    /* maneja un error al intentar cambiar un retiro procesado, informando al usuario. */
