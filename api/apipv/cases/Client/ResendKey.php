 ...
 * Client/ResendKey
 *
 * Reenvía una clave OTP para un retiro.
 *
 ...
 *
 * @throws Exception Si ocurre un error durante el proceso de reenvío.
 */


/* Se reenvía un OTP para la cuenta de cobro especificada mediante GLOBOKAS. */
$Id = $params->Id;
...
$respo = $GLOBOKAS->ResendOtp($CuentaCobro);


/* Verifica si la respuesta fue exitosa y configura datos correspondientes en la respuesta. */
