 ...
 * - Data (array): Información de los productos del usuario.
 *
 * @throws Exception Si ocurre un error general o de validación.
 */


/* Se inicializan objetos relacionados con usuario y se obtienen parámetros de entrada. */
...
/* decodifica parámetros JSON y obtiene datos específicos de una solicitud GET. */
...
/* Asignación de variables y manejo de valor vacío en $SkeepRows. */
...
/* Genera un filtro JSON y busca tokens de usuario en una base de datos. */
...
/* Se crea un array final con información de tokens y proveedores. */
...
/* establece una respuesta api con éxito y datos de objetos. */
