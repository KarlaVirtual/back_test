...
/* Activa la visualización de todos los errores en PHP para facilitar la depuración. */
 ...
 * Client/TestWss
 *
 * Prueba de WebSocket para enviar mensajes a un usuario.
 *
 * @param no
 *
 * @return no
...
/* Se crea un usuario y se obtiene un mensaje para WebSocket usando su ID. */
$Usuario = new Usuario(17884);
...
/* Se crea un objeto WebsocketUsuario y se envía un mensaje a través de WebSocket. */
