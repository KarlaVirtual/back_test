 ...
 * CancelSessions2
 *
 * Cancela sesiones activas de usuarios.
 *
 ...
 * @param int $params->ProveedorId Identificador del proveedor.
 * 
 * 
 ...
 *
 * @throws Exception Si no es posible inactivar el token.
 */

/* Asigna valores de parámetros a variables y crea una instancia de UsuarioToken. */
$SessionId = $params->SessionId;
$Token = $params->Token;
$ProveedorId = $params->ProveedorId;


$UsuarioToken = new UsuarioToken('', '', '', '', '', '', $SessionId);
...
$UsuarioToken->setEstado("I");
    //$UsuarioToken->setUsutokenId($SessionId);

    $UsuarioTokenMySqlDAO = new UsuarioTokenMySqlDAO();
    $UsuarioTokenMySqlDAO->updateState($UsuarioToken);
    $UsuarioTokenMySqlDAO->getTransaction()->commit();

/* gestiona el cierre de sesión de un usuario basado en condiciones específicas. */
    $response = array();

    $UsuarioMandante = new UsuarioMandante($UsuarioToken->getUsuarioId());
    if (in_array($UsuarioMandante->mandante, array('0', '6')) && $UsuarioToken->getProveedorId() == '0') {
...
/* Lanza una excepción si no se puede inactivar un token, con mensaje y código. */

    throw new Exception("No es posible inactivar el token", "50003");
}



/* inicializa un array de respuesta con mensaje, tipo y errores. */
