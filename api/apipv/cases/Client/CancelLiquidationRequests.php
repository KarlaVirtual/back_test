...
/**
 * CancelLiquidationRequests
 *
 * Rechaza solicitudes de liquidación.
 *
...
/* Se asignan valores de parámetros a variables y se inicializa un objeto de clase. */
$Id = $params[0]->Id;
...
/* configura un resumen de comisión con estado, usuario, mensajes y observación. */
...
/* Actualiza el resumen de comisiones y gestiona la transacción del usuario. */
...
/* Código inicializa una respuesta sin errores, con mensaje de éxito y datos vacíos. */
...
/* maneja un error al intentar cambiar un estado de retiro procesado. */
