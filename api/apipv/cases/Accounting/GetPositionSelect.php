...
/**
 * Accounting/GetPositionSelect
 *
 * Obtener las posiciones personalizadas
 *
 ...
 *               - data: array Colección de cargos.
 */

/* Se definen variables para paginación y un array para reglas en un script. */
$OrderedItem = 1;
$SkeepRows = 0;
$MaxRows = 10000;
...
/* crea un filtro JSON y recupera datos de cargos personalizados. */
...
/* Convierte datos JSON en un array, extrayendo id y descripción de "cargo". */
...
/* Código que crea una respuesta estructurada sin errores y con datos finales. */
...
/* Se asignan valores a un arreglo de respuesta en PHP para datos específicos. */
