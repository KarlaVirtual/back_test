...
/**
 * Accounting/SaveIncomeCreditCards
 *
 * Guardar un ingreso por tarjeta de crédito.
 *
 * @param object $params Objeto que contiene los parámetros necesarios para guardar el ingreso.
 * @param string $params ->CloseBoxId ID del cierre de caja.
 * @param string $params ->Concept Concepto del ingreso.
 ...
 * @param int $params ->Type Tipo de ingreso.
 *
...
/* gestiona el cierre de una caja, obteniendo fecha y usuario asociado. */
$estado = "A";
...
/* inicializa objetos de usuario según la disponibilidad de BetShops. */
if ($BetShops != "") {
...
/* obtiene información de un usuario según un ID, actualizando el estado. */
...
/* asigna valores de un objeto a variables específicas. */
...
/* Se crea un objeto 'Ingreso' y se configuran sus propiedades iniciales. */
$Concept = 0;
...
/* establece propiedades de un objeto "Ingreso" con diversos datos. */
...
/* Se asignan valores a propiedades del objeto $Ingreso para su configuración. */
...
/* Se establece un ID de usuario y se asigna una fecha específica al ingreso. */
