 ...
 * Accounting/SaveType
 *
 * Guardar un tipo de centro o de cargo
 *
 * @param object $params Objeto que contiene los parámetros necesarios para la operación
 * @param string $params ->Name Nombre del tipo
 * @param int $params ->Type Tipo de clasificador (0 para centro, 1 para cargo)
 *
...
/* asigna valores a un clasificador y establece su estado y descripción. */
$Name = $params->Name;
$Type = $params->Type;
...
/* configura un clasificador basado en el tipo especificado. */
...
/* Se inserta un clasificador y se confirma la transacción, indicando éxito. */
...
/* Inicializa un mensaje de alerta vacío y un array para errores de modelo. */
