 ...
 * @param int $params->Id: Identificador del cargo.
 ...
 *               - Data: array con los cargos.
 *               - pos: posición de inicio de los datos.
 *               - total_count: número total de registros.
 *               - data: array con los cargos.
 *
 * @throws Exception Si ocurre un error durante la obtención de los cargos.
 */

/* Asignación de parámetros y obtención del número máximo de filas desde la solicitud. */
$Id = $params->Id;
...
/* Establece el valor de $SkeepRows según la solicitud, con un valor predeterminado de 0. */
...
/* Inicializa variables si están vacías: OrderedItem a 1 y MaxRows a 1000. */
if ($OrderedItem == "") {
    $OrderedItem = 1;
}
...
/* Se crea un filtro JSON con reglas vacías para un objeto "Cargo". */
$rules = [];
...
/* obtiene datos de cargos y los transforma en un formato específico. */
...
/* Genera una respuesta estructurada indicando éxito y datos finales sin errores. */
...
/* asigna valores a un arreglo de respuesta con posición, total y datos. */
