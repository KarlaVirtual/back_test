 ...
 * Guardar un empleado
 *
 * @param object $params Objeto que contiene los parámetros necesarios para guardar el empleado.
 * @param string $params->Name Nombre del empleado.
 * @param string $params->Lastname Apellido del empleado.
 * @param int $params->TypeDocument Tipo de documento del empleado.
 * @param string $params->Document Número de documento del empleado.
 * @param int $params->Position Cargo del empleado.
 * @param int $params->Area Área del empleado.
 * @param float $params->Salary Salario del empleado.
 * @param string $params->State Estado del empleado.
 *
...
/* asigna salario y estado a un objeto Empleado. */
...
/* Se asignan valores a las propiedades de un objeto 'Empleado'. */
...
/* Se establecen propiedades del objeto Empleado y se crea un DAO para gestión. */
...
/* Inserta un empleado en la base de datos y confirma la transacción con éxito. */
...
/* Se inicializa un arreglo vacío para almacenar errores del modelo en la respuesta. */
