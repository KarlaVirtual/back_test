...
/**
 * Accounting/GetProvidersSelect
 *
 * Obtener los proveedores personalizado para un select
 *
 * @param object $params Objeto que contiene los parámetros de la solicitud:
 * @param int $params->BetShopId ID del punto de venta.
 * @param string $params->State Estado del proveedor.
...
/* Se definen variables para controlar el número de elementos y reglas en una operación. */
$OrderedItem = 1;
$SkeepRows = 0;
$MaxRows = 10000;
...
/* Se agregan reglas de filtrado a un array y se convierten a JSON. */
array_push($rules, array("field" => "proveedor_tercero.estado", "data" => "A", "op" => "eq"));
...
/* transforma datos JSON de proveedores en un arreglo estructurado. */
...
foreach ($data->data as $key => $value) {
    ...
    $array["reference"] = $value->{"proveedor_tercero.documento"};
...
/* configura una respuesta sin errores con datos y mensajes de éxito. */
...
/* asigna valores a un arreglo $response para una respuesta estructurada. */
