...
/**
 * Accounting/SaveProvidersThird
 *
 * Guardar proveedor tercero
 *
 ...
 * @param int $params->State Estado del proveedor (1 para activo, 0 para inactivo)
 * @param string $params->Nit Documento del proveedor
 * @param int $params->Partner Identificador del mandante
 * @param int $params->Country Identificador del país
 * @param string $params->Email Correo electrónico del proveedor
 *
...
/* Se crea un objeto ProveedorTercero y se establecen sus propiedades. */
...
/* Se asignan valores a un objeto y se crea una instancia de DAO correspondiente. */
...
/* Inserta un proveedor en la base de datos y confirma la transacción. */
$ProveedorTerceroMySqlDAO->insert($ProveedorTercero);
$ProveedorTerceroMySqlDAO->getTransaction()->commit();

/* Genera formato de respuesta del servicio */
