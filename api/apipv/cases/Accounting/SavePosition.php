...
/**
 * Procesa y guarda la posición de un cargo.
 *
 * @param object $params Objeto que contiene los parámetros de entrada:
 * @param string $Name: Nombre del cargo.
 * @param int $TypePosition: Tipo de posición.
 * @param int $State: Estado del cargo.
 *
 *
...
/* Se asignan parámetros a variables y se establece el estado de un objeto "Cargo". */
$Name = $params->Name;
...
/* Se configuran atributos en un objeto Cargo y se inicializa un DAO. */
...
/* inserta un registro y confirma la transacción sin errores. */
