 ...
 * @param string $params->Abbreviated Nombre abreviado del partido.
 * @param string $params->Name Nombre del partido.
 * @param string $params->NameInternational Nombre internacional del partido.
 * @param string $params->NameTranslate Traducción del nombre del partido.
 * @param int $params->CompetitionId Identificador de la competencia.
 * @param string $params->DateTime Fecha y hora del partido.
 * @param string $params->Status Estado del partido.
 * 
 *
...
/* Se asignan valores de parámetros a un objeto de evento. */
...
/* Asigna valores a propiedades de un objeto llamado IntEvento. */
...
/* Inserta un evento en la base de datos y confirma la transacción. */
...
try {
    ...
    /* Captura excepciones y guarda el código y descripción del error en la respuesta. */
...
/* Esta línea asigna el valor de la variable $response a sí misma. */
$response = $response;