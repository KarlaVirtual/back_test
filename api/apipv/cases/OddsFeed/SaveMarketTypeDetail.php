 ...
 *
 * Guarda el detalle de un tipo de mercado en la base de datos.
 *
 * @param object $params Objeto con los siguientes atributos:
 * @param int $params->MarketTypeId Identificador del tipo de mercado.
 * @param string $params->Option Opción del mercado.
 * @param int $params->OptionId Identificador de la opción.
 * @param string $params->Status Estado del detalle.
 * 
 *
...
/* Se asignan valores de parámetros a variables y se crea una instancia de IntApuestaDetalle. */
...
/* Asigna valores a propiedades de un objeto relacionado con apuestas deportivas. */
...
/* Código que inserta un detalle de apuesta y confirma la transacción en MySQL. */
...
try {
    ...
    /* Manejo de excepciones que guarda código y descripción de errores en una respuesta. */
...
/* asigna la variable $response a sí misma, sin cambios. */
$response = $response;
