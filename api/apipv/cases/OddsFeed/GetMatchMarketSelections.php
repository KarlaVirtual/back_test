 ...
 *
 * Este script obtiene las selecciones de mercado de un partido específico.
 *
 * @param array $params Parámetros de entrada que incluyen:
 * @param string $params->matchId Identificador del partido para filtrar las selecciones.
 * @param int $params->competitionId Identificador de la competencia asociada (valor predeterminado: 1).
 *
 ...
 * - array $Data: Datos de las selecciones de mercado.
 *
 * @throws Exception Si ocurre un error en la consulta o procesamiento de datos.
 */

/* establece un identificador de partido y responde sin errores. */
...
/* define una respuesta estructurada con mensaje, errores y datos vacíos. */
...
/* Genera un JSON con reglas para obtener detalles de apuestas desde una base de datos. */
...
/* procesa apuestas y guarda datos relevantes en un arreglo final. */
    $final = array();
