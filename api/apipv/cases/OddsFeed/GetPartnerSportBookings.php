 ...
 *
 * Este script obtiene información de los deportes disponibles para un partner.
 *
 * @param array $_REQUEST Parámetros de entrada recibidos por solicitud HTTP.
 * @param string $_REQUEST["isLive"] Indica si los deportes están en vivo.
 *
 ...
 *                         - Data (array): Información detallada de los deportes disponibles.
 */


/* Código para manejar una solicitud, indicando éxito y sin errores. */
...
/* Se inicializa una estructura de datos y un objeto IntDeporte para reglas. */
$response["Data"] = [];
...
/* obtiene, decodifica y organiza deportes en un arreglo final. */
