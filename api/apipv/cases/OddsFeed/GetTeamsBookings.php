 ...
 *
 * Este script obtiene información detallada de los equipos relacionados con un evento específico.
 *
 * @param object $params Objeto que contiene los parámetros de entrada.
 * @param string $params->matchId ID del evento para el cual se desea obtener información.
 *
 ...
 *                         - Data (array): Información detallada de los equipos relacionados con el evento.
 *
 * @throws Exception Si ocurre algún error durante la ejecución.
 */


/* asigna un ID de partida y establece una respuesta exitosa. */
...
if ($matchId != "") {
    ...
    /* Construye un JSON para filtrado basado en un ID de competencia. */
...
*/
    ...
    /* Se crea un filtro JSON y se obtienen detalles del evento relacionado. */
    ...
    /* Convierte datos JSON en un array estructurado en PHP para eventos. */
