 ...
 *
 * Guarda una competencia en la base de datos.
 *
 * @param object $params Objeto con los siguientes atributos:
 * @param string $params->Abbreviated Nombre abreviado de la competencia.
 * @param string $params->Name Nombre de la competencia.
 * @param string $params->NameInternational Nombre internacional de la competencia.
 * @param string $params->NameTranslate Traducción del nombre de la competencia.
 * @param int $params->RegionId Identificador de la región.
 * @param string $params->Status Estado de la competencia.
 * 
 *
 * @return array Respuesta con los siguientes atributos:
 *  - ErrorCode (int): Código de error (0 si no hay error).
...
/* Se crea un objeto IntCompetencia y se asignan propiedades relacionadas con la competencia. */
...
/* Asignación de valores a propiedades de objeto y preparación de respuesta sin errores. */
...
/* inserta una competencia y confirma la transacción en MySQL. */
...
try {
    ...
    /* Manejo de excepciones en PHP, registrando error y descripción en respuesta. */
...
/* asigna una variable de respuesta a sí misma, sin modificar su valor. */
$response = $response;