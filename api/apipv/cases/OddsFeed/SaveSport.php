 ...
 * OddsFeed/SaveSport
 *
 * Este script guarda un deporte en la base de datos.
 *
 * @param object $params Objeto que contiene los siguientes valores:
 * @param string $params->Abbreviated Nombre abreviado del deporte.
 * @param string $params->Name Nombre del deporte.
 * @param string $params->NameInternational Nombre internacional del deporte.
 * @param string $params->NameTranslate Traducción del nombre del deporte.
 * @param string $params->Status Estado del deporte (activo/inactivo).
 * 
 *
...
/* asigna parámetros a variables y crea una instancia de IntDeporte. */
...
/* Asigna valores a propiedades del objeto IntDeporte para representar un deporte. */
...
/* Inserta un registro de deporte y confirma la transacción sin errores. */
...
try {
    ...
    /* Captura excepciones y asigna código y descripción al array de respuesta. */
...
/* asigna la variable $response a sí misma, sin realizar cambios. */
$response = $response;
