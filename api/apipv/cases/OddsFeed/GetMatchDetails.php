 ...
 *
 * Este script obtiene los detalles de un partido específico.
 *
 * @param array $params Parámetros de entrada que incluyen:
 * @param string $params->matchId Identificador del partido para filtrar los detalles.
 *
 ...
 * - array $Data: Datos de los detalles del partido.
 */


/* asigna un ID de partido y prepara una respuesta exitosa. */
...
if ($matchId != "") {
    ...
    /* Genera una consulta JSON para obtener detalles de eventos específicos en una base de datos. */
    ...
    /* transforma datos de apuestas a un arreglo estructurado final. */
    $final = array();
