 ...
 *
 * Este script guarda un mercado asociado a un partido en la base de datos.
 *
 ...
 * @param int $params->MarketId Identificador del mercado.
 * @param int $params->Id Identificador del detalle de la apuesta.
 * @param float $params->Price Precio de la apuesta.
 * @param string $params->State Estado de la apuesta.
 * 
 *
...
try {
    ...
    /* Se crea un objeto de apuesta con información del evento y su estado inicial. */
    ...
    /* establece propiedades de un objeto de apuesta y obtiene una transacción de la base de datos. */
    ...
    /* Se obtiene una transacción del objeto `TransaccionJuegoMySqlDAO` mediante el método `getTransaction()`. */
    ...
    if ($Transaction->isIsconnected()) {
        ...
        /* Se inserta un evento de apuesta y sus detalles en la base de datos. */
        ...
        /* Confirma una transacción y asigna un mensaje de éxito a la respuesta. */
        $Transaction->commit();
    ...
    /* Manejo de excepciones en PHP para capturar y describir errores. */
