 ...
 *
 * Guarda el detalle de un partido en la base de datos.
 *
 * @param object $params Objeto con los siguientes atributos:
 * @param int $params->MatchId Identificador del partido.
 * @param string $params->Type Tipo de evento.
 * @param int $params->Id Identificador del detalle.
 * @param mixed $params->Value Valor asociado al detalle.
 *
...
try {
    ...
    /* Se crea un objeto con detalles de un evento utilizando parámetros específicos. */
    ...
    /* Inserta un nuevo registro en la base de datos y gestiona transacciones. */
    ...
    /* establece una respuesta de éxito con código y descripción. */
    ...
    /* Captura excepciones y genera un mensaje de error con código y descripción. */
