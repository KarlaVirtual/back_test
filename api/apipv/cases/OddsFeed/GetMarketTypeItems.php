 ...
 *
 * Este script obtiene los ítems de los tipos de mercado por deporte.
 *
 * @param array $params Parámetros de entrada que incluyen:
 * @param int $params->sportId ID del deporte.
 * @param string $params->marketType Tipo de mercado.
 * 
 *
 ...
 *  - Data (array): Datos obtenidos de los tipos de mercado.
 */


/* asigna un ID de deporte a una solicitud y genera una respuesta exitosa. */
...
/* crea un arreglo asociativo con datos específicos sobre opciones. */
$response["Data"] = array(
    array("Id" => 1,
        "OptionId" => "1",
        "Option" => "1",
...
/* obtiene parámetros y genera una respuesta de éxito sin errores. */
...
/* Se inicializan respuestas y se construye un JSON para filtrar datos en una consulta. */
$response["ModelErrors"] = [];
$response["Data"] = [];
...
/* Extrae detalles de apuestas, los organiza en un array y los decodifica en formato JSON. */
