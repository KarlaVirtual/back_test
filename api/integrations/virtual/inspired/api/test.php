 ...
 *
 * @var mixed $log_directory           Variable que almacena la ruta del directorio donde se guardan los registros o logs del sistema.
 * @var mixed $results_array           Variable que almacena un arreglo de resultados de un proceso o evaluación.
 * @var mixed $dir                     Variable que almacena un directorio o ruta de archivos en el sistema.
 * @var mixed $hideName                Variable que indica si el nombre debe ser ocultado en una interfaz o resultado.
 ...
 * @var mixed $content                 Variable que almacena el contenido de un archivo, mensaje o dato.
 ...
 * @var mixed $string2                 Variable que almacena una segunda cadena de texto (string) para su uso en un proceso.
...
$dir = "/var/www/html/casino/admin/dao/integrations/virtual/inspired/api/xml/";

/* Hide this */
$hideName = array('.', '..', '.DS_Store');
$cont = 0;

$content = (file_get_contents('/var/www/html/casino/admin/dao/integrations/virtual/inspired/api/log_2018-07-30.log'));

$files = explode("----------   /admin/dao/integrations/virtual/inspired/api/   ------------", $content);

foreach ($files as $filename) {
    $cont = $cont + 1;
    print_r($filename);

    if (strpos($filename, "message") !== false) {
        $string = $filename;
        ...
        $string2 = '<message MessageType="NoMoreBets" MessageDateTime="2018-07-30T14:26:03+01:00" MessageFormatVersion="2.0" ControllerId="4" TransactionId="40378316">
<event EventId="40150267" EventType="1" EventTime="2018-07-30T14:26:00+01:00" EventGUID="83657185-8BCB-4DAF-89C0-AE495769AF86"/>
</message>
';
...
/**
 * Envía un mensaje a través de WebSocket con los datos de juegos y eventos procesados.
 *
 * @param array $gamearray  Arreglo que contiene los identificadores de los juegos procesados.
 * @param array $eventarray Arreglo que contiene los identificadores de los eventos procesados.
 *
 * @return void
 */
