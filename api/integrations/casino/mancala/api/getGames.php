<?php
/**
 * Este archivo contiene un script para obtener juegos de la API de casino 'mancala'
 ...
 * @var mixed $data   Datos enviados como cuerpo de la petición POST.
 * @var mixed $result Resultado devuelto por la ejecución de la petición CURL.
 */
