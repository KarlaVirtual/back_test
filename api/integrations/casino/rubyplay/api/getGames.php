<?php
/**
 * Este archivo contiene un script para obtener información de juegos desde la API de casino 'rubyplay'
 * utilizando una petición CURL y procesar la respuesta obtenida.
 *
 * @category   Red
 * @package    API
 ...
 *
 * @var resource $curl     Recurso CURL inicializado para realizar la petición HTTP.
 * @var mixed    $response Respuesta obtenida de la API, decodificada desde JSON.
 */
