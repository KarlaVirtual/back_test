...
/**
 * Este archivo contiene un script para obtener juegos de la API de casino 'Pragmatic Play'
 ...
 *
 * @var mixed $ch     Recurso CURL inicializado para realizar la petición HTTP.
