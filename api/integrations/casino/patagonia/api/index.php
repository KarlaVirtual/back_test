...
/**
 * Este archivo contiene un script para procesar y manejar las solicitudes de la API del casino 'Patagonia'.
...
use Backend\integrations\casino\Patagonia;
...
if (true) {
    ...
    switch ($method) {
        ...
        case "GetAccountDetails":
            ...
            $Patagonia = new Patagonia("", "", $Token);

            $response = ($Patagonia->Auth());
        ...
        case "PlaceBet":
            ...
            $response = ($Patagonia->Debit($GameReference, $TransactionID, "", $BetAmount, $BetReferenceNum, json_encode($datos)));
        ...
        case "AwardWinnings":
            ...
            $response = ($Patagonia->Credit($GameReference, $TransactionID, "", $WinAmount, $WinReferenceNum, $isEnd, json_encode($datos)));
        ...
        case "RefundBet":
            ...
            $response = ($Patagonia->Rollback($GameReference, $TransactionID, "", $RefundAmount, $BetReferenceNum, json_encode($datos)));
            break;
