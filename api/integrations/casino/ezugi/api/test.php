 ...
 * en la integración con el casino Ezugi, utilizando datos de transacciones y usuarios.
 *
 * @category   Red
 * @package    API
 ...
 * @var string  $token         Token de autenticación para la operación.
 ...
 * @var string  $currency      Moneda utilizada en la operación.
 ...
 * @var string  $seatId        Identificador del asiento en el juego.
 */
