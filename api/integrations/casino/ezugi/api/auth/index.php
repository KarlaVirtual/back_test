 ...
 * en la integración del casino 'Ezugi'.
 *
 * @category   API
 ...
 * @var string $operatorId Identificador del operador enviado en la solicitud.
 * @var string $token      Token de autenticación enviado en la solicitud.
