...
/**
 * Este archivo contiene un script para procesar solicitudes de débito en la integración
 * con el casino 'Ezugi', utilizando datos proporcionados en el cuerpo de la solicitud.
 *
 * @category   Casino
 * @package    API
...
if ($body != "") {
    ...
    print_r($Ezugi->Debit($gameId, $uid, $betTypeID, $currency, $debitAmount, $serverId, $roundId, $transactionId, $hash));
}