 ...
 * específicamente para la integración con Ezugi, incluyendo autenticación, crédito, débito y reversión de transacciones.
 *
 * @category   Red
 * @package    API
 ...
 * @var string  $log  Variable que almacena los registros de entrada de la API.
 */
