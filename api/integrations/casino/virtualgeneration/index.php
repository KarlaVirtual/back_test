<?php
/**
 * Este archivo contiene un script para procesar solicitudes relacionadas con la API de casino 'virtualgeneration'.
 * Maneja operaciones como autenticación, crédito, débito y reversión de transacciones.
 *
 * @category   Casino
 * @package    API
 ...
 *
 * @var mixed $_SERVER['REQUEST_URI'] URI de la solicitud actual, utilizada para determinar la operación a realizar.
