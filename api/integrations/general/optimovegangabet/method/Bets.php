...
/**
 * Archivo encargado de procesar y generar reportes de apuestas y tickets.
 *
 * Este script recibe parámetros de entrada, realiza consultas a la base de datos
 * y genera un conjunto de datos estructurados con información sobre apuestas y tickets.
 * Incluye operaciones como el cálculo de ingresos netos, clasificación de tickets,
 * y generación de respuestas en formato JSON.
 *
 * @category   Red
 * @package    API
