...
/**
 * Este archivo contiene un script para procesar solicitudes HTTP, manejar excepciones
 * y cargar dinámicamente archivos PHP basados en los datos de entrada.
 *
 * @category Red
 * @package  API
 * @author   Desconocido
...
try {
    ...
    $log = $log . ($URI);
    $log = $log . ($body);
    syslog(LOG_WARNING, "OPTIMOVEREQUEST :" . $URI . ' - ' . json_encode($_SERVER) . json_encode($_REQUEST));
