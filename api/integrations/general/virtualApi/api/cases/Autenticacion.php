...
/**
 * Archivo de autenticación para la API.
 *
 * Este archivo contiene la lógica para autenticar usuarios mediante credenciales
 * y generar un token JWT para la autorización de solicitudes.
 *
 * @category   Red
 * @package    API
 ...
 * @var mixed $clave2                   Esta variable guarda la clave o contraseña para autenticación y acceso seguro al sistema (generalmente encriptada).
...
if ($ConfigurationEnvironment->isDevelopment()) {
    ...
    $usuario = 'ApiVirtualSoft';
    $clave = 'NJcFpK2BG@Xf';
    $usuario2 = 'ApiCentribal';
    $clave2 = 'NJcFpK2BG@Xf2';
}


if (($_GET["Usuario"] === $usuario && $_GET["Clave"] === $clave) || ($_GET["Usuario"] === $usuario2 && $_GET["Clave"] === $clave2)) {
