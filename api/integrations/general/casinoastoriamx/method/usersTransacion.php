...
/**
 * Este archivo contiene un script para procesar transacciones de usuarios en el sistema.
 * Se encarga de validar tokens, procesar parámetros de entrada y ejecutar consultas
 * relacionadas con el historial de usuarios, devolviendo los datos en formato JSON.
 *
 * @category Red
 * @package  API
 * @author   Desconocido
...
where 1 = 1
  AND ((usuario.mandante)) = '7' AND usuario_historial.tipo IN (10,40,41,15)
