 ...
 * Archivo `users.php`
 *
 * Este archivo contiene la lógica para procesar solicitudes relacionadas con usuarios en el sistema.
 * Incluye validaciones de token, manejo de parámetros de entrada, generación de filtros y obtención de datos
 * de usuarios desde la base de datos. También se encarga de formatear y devolver la respuesta en formato JSON.
 *
 * @category   Red
 * @package    API
