...
/**
 * Archivo de autenticación para la integración con Casino Astoria MX.
 *
 * Este script maneja la autenticación de usuarios mediante la validación de credenciales
 * y la generación de un token JWT para sesiones seguras. Incluye configuraciones específicas
...
/**
 * Obtiene y decodifica los parámetros enviados en la solicitud HTTP.
 */
...
/**
 * Configura el entorno de ejecución y define credenciales según el entorno.
 */
...
if ($params->user === $usuario && $params->password === $clave) {
    ...
    /**
     * Genera el encabezado del token JWT.
     */
    $header = json_encode([
        'alg' => 'HS256',
        'typ' => 'JWT'
    ...
    /**
     * Prepara la respuesta de éxito con el token generado.
     */
    $response = array();
