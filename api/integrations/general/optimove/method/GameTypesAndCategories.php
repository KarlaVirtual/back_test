...
/**
 * Archivo que contiene la lógica para obtener tipos y categorías de juegos.
 *
 * Este script procesa una solicitud HTTP, ejecuta consultas SQL para obtener datos
 * relacionados con productos y categorías, y genera una respuesta en formato JSON.
 *
 * @category   Red
 * @package    API
