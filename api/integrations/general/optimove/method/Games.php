...
/**
 * Este archivo contiene la lógica para procesar y generar reportes de apuestas
 * basados en datos de transacciones de juegos. Incluye consultas SQL para
 * obtener estadísticas y métricas relacionadas con las apuestas realizadas
 * por los usuarios en un rango de fechas específico.
 *
 * @category   Reporte
 * @package    API
