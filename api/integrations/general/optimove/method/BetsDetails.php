 ...
 * desde una base de datos, incluyendo la validación de parámetros de entrada,
 * la ejecución de consultas SQL y la generación de respuestas en formato JSON.
 *
 * @category   Red
 * @package    API
...
foreach ($Tickets as $key => $value) {
    ...
    $array["Discipline"] = $value["itd.Discipline"];
