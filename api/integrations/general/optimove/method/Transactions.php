...
/**
 * Este archivo contiene la implementación de métodos relacionados con transacciones
 * en el sistema, incluyendo consultas a la base de datos y procesamiento de datos
 * relacionados con usuarios, recargas y retiros.
 *
 * @category   Red
 * @package    API
