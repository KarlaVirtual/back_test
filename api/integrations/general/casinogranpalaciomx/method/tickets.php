 ...
 * en el sistema de Casino Gran Palacio MX. Incluye la validación de tokens,
 * consultas a la base de datos y generación de respuestas en formato JSON.
 *
 * @category   Red
 * @package    API
...
WHERE 1 = 1
  ...
  AND usuario.mandante = '4') it_ticket_enc
GROUP BY ticket_id ";
        ...
        /**
         * Procesa los resultados de los tickets.
         */
...
where 1 = 1
  ...
  AND usuario_mandante.mandante = '4'";
...
//$transaccion->getConnection()->beginTransaction();
        ...
        /**
         * Procesa los resultados de las apuestas.
         */
        ...
        /**
         * Combina los resultados de tickets y apuestas.
         */
        ...
        if ( ! empty($aux)) {
            ...
            $response["TotalCount"] = intval(oldCount($aux));
            $response["Data"] = $aux;
        } else {
            $response["Error"] = false;
        ...
        /**
         * Lanza una excepción si el token no coincide.
         */
