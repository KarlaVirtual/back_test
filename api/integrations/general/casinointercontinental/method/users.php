 ...
 *
 * Este script procesa solicitudes HTTP, valida tokens de autenticación y realiza consultas
 * personalizadas sobre los usuarios registrados en el sistema. Además, incluye funciones
 * auxiliares para el manejo de datos y generación de respuestas en formato JSON.
 *
 * @category   Red
 * @package    API
