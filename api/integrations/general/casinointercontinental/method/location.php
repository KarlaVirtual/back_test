...
/**
 * Este archivo contiene la lógica para procesar solicitudes relacionadas con la obtención de información
 * sobre puntos de venta y usuarios en un sistema de apuestas. Incluye validación de tokens, manejo de
 * parámetros de entrada, generación de filtros y respuesta en formato JSON.
 *
 * @category   Red
 * @package    API
