 ...
 * en el sistema de Casino Intercontinental. Incluye validaciones de token, manejo de parámetros
 * de entrada y consultas a la base de datos para obtener información de movimientos financieros.
 *
 * @category Red
 * @package  API
 * @author   Desconocido
...
where 1 = 1
  AND ((usuario.mandante)) = '5' AND usuario_historial.tipo IN (10,40,41,15)
