...
/**
 * Este archivo contiene la lógica para procesar solicitudes relacionadas con tickets
 * en el sistema de Casino Intercontinental. Incluye validaciones de token, consultas
 * a la base de datos y generación de respuestas en formato JSON.
 *
 * @category   Red
 * @package    API
...
$Mandante = new Mandante(5);

/**
 * Procesa los parámetros de entrada desde el cuerpo de la solicitud.
 */
$params = file_get_contents('php://input');
$params = json_decode($params);

/**
 * Convierte las fechas de entrada a formato "Y-m-d H:i:s".
 */
...
/**
 * Configura el entorno de ejecución y define el usuario según el entorno.
 */
$ConfigurationEnvironment = new ConfigurationEnvironment();
if ($ConfigurationEnvironment->isDevelopment()) {
    $usuario = 'casinointercontinentalVS';
} else {
    $usuario = 'casinointercontinentalVS';
}
$header = json_encode([
...
/**
 * Valida el token de la solicitud.
 */
...
WHERE 1 = 1
  ...
  AND usuario.mandante = '5') it_ticket_enc
GROUP BY ticket_id ";
    ...
    /**
     * Procesa los resultados de las consultas y genera la respuesta.
     */
...
where 1 = 1
  ...
  AND usuario_mandante.mandante = '5'";
