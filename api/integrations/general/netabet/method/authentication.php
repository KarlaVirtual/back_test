...
/**
 * Archivo de autenticación para la integración con Netabet.
 *
 * Este archivo contiene la lógica para autenticar usuarios mediante un sistema
 * de validación de credenciales y generación de tokens JWT. Se utiliza en el
 * contexto de la integración con Netabet y maneja diferentes configuraciones
