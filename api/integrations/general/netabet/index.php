...
/**
 * Este archivo contiene un script para manejar solicitudes HTTP, procesar datos JSON,
 * cargar archivos dinámicamente y gestionar errores específicos relacionados con
 * operaciones de integración en la API de Netabet.
 *
 * @category Red
 * @package  API
 * @author   Desconocido
