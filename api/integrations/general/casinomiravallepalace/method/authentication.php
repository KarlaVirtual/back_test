...
/**
 * Este archivo contiene la lógica de autenticación para el sistema del Casino Miravalle Palace.
 * Se encarga de validar las credenciales de los usuarios y generar un token JWT para la autenticación.
 *
 * @category Seguridad
 * @package  Auth
 * @author   Desconocido
