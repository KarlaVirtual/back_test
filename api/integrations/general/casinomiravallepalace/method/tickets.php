...
/**
 * Este archivo contiene un script para procesar solicitudes relacionadas con tickets y transacciones
 * en el sistema de apuestas. Incluye la validación de tokens, consultas SQL para obtener datos de tickets
 * y transacciones, y la generación de respuestas en formato JSON.
 *
 * @category   Red
 * @package    API
...
WHERE 1 = 1
  ...
  AND usuario.mandante = '3') it_ticket_enc
GROUP BY ticket_id ";
...
where 1 = 1
  ...
  AND usuario_mandante.mandante = '3'";
