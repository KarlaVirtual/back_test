...
/**
 * Archivo que contiene la lógica para procesar solicitudes relacionadas con usuarios.
 *
 * Este script maneja la autenticación mediante tokens, la validación de parámetros
 * y la generación de respuestas en formato JSON. Además, incluye funciones para
 * filtrar y formatear datos de usuarios según los criterios especificados.
 *
 * @category   Red
 * @package    API
