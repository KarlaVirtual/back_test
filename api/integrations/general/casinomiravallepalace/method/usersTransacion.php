...
/**
 * Este archivo contiene un script para procesar transacciones de usuarios
 * en el sistema del Casino Miravalle Palace. Incluye validaciones de token,
 * manejo de parámetros de entrada, consultas a la base de datos y generación
...
where 1 = 1
  AND ((usuario.mandante)) = '3' AND usuario_historial.tipo IN (10,40,41,15)
