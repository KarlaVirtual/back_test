...
/**
 * Este archivo maneja la confirmación de pagos para la integración PayForFun.
 * Procesa los datos recibidos, actualiza el estado de las transacciones y registra los logs correspondientes.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\PayForFun
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
...
if (isset($data)) {
    ...
    $TransactionId = $confirm->MerchantInvoiceId;
