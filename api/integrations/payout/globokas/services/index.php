...
/**
 * Este archivo maneja las solicitudes HTTP entrantes para la integración de pagos con Globokas.
 * Procesa el cuerpo de la solicitud, valida los parámetros y ejecuta el método correspondiente
 * según la lógica definida en los archivos de la API.
 *
 * @category   Red
 * @package    API
...
try {
    ...
    if ($body != "") {
        ...
        $extension = "";
        $filename = __DIR__ . '/api/' . $data->method . $extension . ".php";
