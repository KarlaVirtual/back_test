...
/**
 * Este archivo contiene la implementación del servicio ResendOtp para la integración con GLOBOKAS.
 *
 * El propósito principal de este script es procesar solicitudes de reenvío de OTP (One-Time Password)
 * para usuarios, validando los datos de entrada, generando tokens de autenticación y comunicándose
 * con el servicio externo GLOBOKAS para completar la operación.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\Globokas\Services\Api
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
 ...
 * @var mixed $TipoDoc                  Variable que almacena el tipo de documento utilizado para identificar al usuario (por ejemplo, cédula, pasaporte).
...
$datas = $Registro->getRegistroCustom("registro.tipo_doc,registro.cedula", "registro.usuario_id", "asc", 0, 1, $jsonfiltro, true);
$datas = json_decode($datas);

$TipoDoc = ($datas->data[0]->{"registro.tipo_doc"});
...
$response = $GLOBOKAS->ResendOtp($identifier, $tipoDoc, $order);
