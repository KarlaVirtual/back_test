...
/**
 * Archivo `EditOrderPage.php`
 *
 * Este archivo contiene la lógica para procesar solicitudes relacionadas con la edición de órdenes
 * en el sistema de integración de pagos GLOBOKAS. Incluye la generación de tokens JWT, validación
 * de encabezados HTTP y la interacción con servicios externos para procesar las órdenes.
 *
 * @category   Red
 * @package    API
...
$response = $GLOBOKAS->EditOrderPage($Id, $valor);
