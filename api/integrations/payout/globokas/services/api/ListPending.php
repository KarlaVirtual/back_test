...
/**
 * Este archivo contiene un script para listar transacciones pendientes utilizando
 * el servicio de integración GLOBOKAS. Se procesan parámetros de entrada, se generan
 * tokens de autenticación y se realizan consultas a la base de datos para obtener
...
$response = $GLOBOKAS->ListPending($identifier, $startDate, $endDate, $pageNumber, $pageSize);
