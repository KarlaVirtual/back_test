 ...
 * Archivo `Delete.php`
 *
 * Este archivo contiene la implementación de un servicio para eliminar registros
 * relacionados con la integración de pagos GLOBOKAS. Incluye la generación de tokens
 * JWT, validación de encabezados, y la construcción de filtros para consultas a la base de datos.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\Globokas\Services
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
...
$response = $GLOBOKAS->Delete2($identifier, $tipoDoc, $order);
