...
/**
 * Este archivo contiene la implementación del servicio para obtener el balance
 * de la integración con GLOBOKAS. Incluye la generación de un token JWT y la
 * validación de encabezados HTTP para la autenticación.
 *
 * @category   Red
 * @package    API
