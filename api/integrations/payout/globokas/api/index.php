...
/**
 * Este archivo es un script para manejar solicitudes HTTP y procesar datos
 * relacionados con la integración de pagos a través de la API de Globokas.
 *
 * Funcionalidades principales:
 * - Procesar solicitudes HTTP entrantes.
 * - Leer y decodificar el cuerpo de las solicitudes.
 * - Cargar dinámicamente archivos de casos según el URI.
 * - Manejar excepciones y errores específicos con códigos personalizados.
 *
 * @category   Red
 * @package    API
...
try {
    ...
    if ($body != "") {
        ...
        $extension = ".php";
        $filename = __DIR__ . "/cases/" . $arraySuper[count($arraySuper) - 1] . $extension;
