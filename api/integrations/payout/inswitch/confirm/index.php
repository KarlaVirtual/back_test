 ...
 * Procesa los datos recibidos, actualiza el estado de las transacciones y registra los eventos en el sistema.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\Inswitch
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
...
if (isset($data)) {
    ...
    $id = $confirm->transactionReference;
    $TransactionId = $confirm->requestingOrganisationTransactionReference;
