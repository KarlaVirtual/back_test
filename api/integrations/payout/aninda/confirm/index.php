...
/**
 * Este archivo maneja la confirmación de pagos a través de la integración Aninda.
 ...
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\Aninda
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
 ...
 * @var mixed $transaction_id              Variable que almacena el externo único de una transacción.
...
if (isset($data)) {
    ...
    $transactionid = $data->TraderTransactionID;
    $status = $data->Status;
    ...
    if ($estado != "P") {
        ...
        $TransaccionProducto->setExternoId($transaction_id);
