...
/**
 * Este archivo maneja la confirmación de pagos a través de la integración con WePay.
 * Procesa los datos recibidos, actualiza el estado de las transacciones y registra
 * los eventos en el sistema.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\WePay
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
...
if (isset($data)) {
    $transproducto_id = $data->MerchantReference;
