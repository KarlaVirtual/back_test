...
/**
 * Este archivo maneja la confirmación de transacciones de retiro a través de la integración con CoinsPaid.
 * Procesa los datos recibidos, actualiza el estado de las transacciones y registra los logs correspondientes.
 *
 * @category   Red
 * @package    API
...
if (isset($data)) {
    ...
    if ($confirm->type == 'withdrawal_exchange') {
        $id = $confirm->id;
        $TransactionId = $confirm->foreign_id;
        $status = $confirm->status;
        $comment = $confirm->error;
