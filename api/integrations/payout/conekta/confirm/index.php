 ...
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payout\Conekta
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
...
if (isset($data)) {
    $transactionid = $data->data->object->payout_order_id;
    $status = $data->type;
    $responseBank = $data->description;

    $Proveedor = new \Backend\dto\Proveedor("", "CONEKTARETIROS");
    $Producto = new \Backend\dto\Producto("", "CONEKTARETIROS", $Proveedor->proveedorId);
    $estado = 'P';
    ...
    if ($estado != "P") {
        ...
        $TransaccionProducto = new TransaccionProducto("", $transactionid, $Producto->productoId);
