...
/**
 * Este archivo maneja la confirmación de pagos a través de la integración con Paygate.
 * Procesa los datos recibidos, registra logs y realiza la confirmación de transacciones.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payment\Paygate
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
 ...
 * @var mixed $Paygate      Variable que almacena información relacionada con Paygate.
 */
...
use Backend\integrations\payment\Paygate;
...
if (isset($data)) {
    ...
    /* Procesamos */
    $Paygate = new Paygate($invoice, $usuario_id, $documento_id, $valor, $control, $result);
    $Paygate->confirmation(json_encode($data));
}