...
/**
 * Archivo principal para la integración de pagos con PayPhonePay.
 *
 * Este script se encarga de procesar solicitudes GET, decodificar parámetros
 * y configurar el entorno para la integración con los servicios de pago.
 *
 * @category   Red
 * @package    API
