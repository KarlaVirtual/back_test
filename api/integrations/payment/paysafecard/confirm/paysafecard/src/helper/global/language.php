...
class Language
{
    ...
    /**
     * Objeto de registro que contiene configuraciones globales.
     *
     * @var object
     */
    protected $_registry;
     ...
     *
     * Inicializa la clase configurando el directorio de idiomas,
     * obteniendo los idiomas permitidos y cargando el idioma predeterminado.
     *
     * @param object $_registry Objeto de registro que contiene configuraciones globales.
     */
