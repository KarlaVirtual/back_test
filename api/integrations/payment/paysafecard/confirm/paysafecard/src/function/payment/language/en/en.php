 ...
 *
 * Este archivo contiene una lista de mensajes de error y validación utilizados en el contexto de la integración
 * de pagos con Paysafecard. Los mensajes están organizados en un arreglo asociativo para facilitar su uso
 * en diferentes partes del sistema.
 *
 * @category   Red
 * @package    API
 * @subpackage Integración de Pagos
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
