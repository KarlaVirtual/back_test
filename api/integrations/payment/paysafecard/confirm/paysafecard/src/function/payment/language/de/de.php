...
/**
 * Archivo de configuración de mensajes de error y validación para la integración de pagos con paysafecard.
 *
 * Este archivo contiene un conjunto de mensajes en alemán que se utilizan para validar y manejar errores
 * relacionados con el proceso de pago. Los mensajes están organizados en claves asociativas que permiten
 * su fácil acceso y uso en diferentes partes del sistema.
 *
 * @category   Red
 * @package    API
...
/**
 * Mensajes de error y validación en alemán.
 *
 * @var array $_ Contiene los mensajes de error y validación utilizados en el sistema.
 */
