 ...
 * en el proceso de pago. Los mensajes están organizados en un array asociativo y cubren diferentes escenarios
 * como validaciones de entrada, errores de conexión y estados de pago.
 *
 * @category   Red
 * @package    API
