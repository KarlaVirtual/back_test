 ...
 * realizar pagos, validar parámetros y generar disposiciones de cliente.
 */
class payment extends paysafecard_base
{
     ...
     * Crea un nuevo pago.
     *
     * Valida los parámetros proporcionados y genera una disposición de cliente
     * si los datos son correctos.
     *
     * @param array $parameter Parámetros del pago.
     *
     * @return boolean|string URL del panel del cliente o `false` en caso de error.
     */
    ...
    /**
     * Crea una disposición de cliente.
     *
     * Realiza una acción en la API para generar una disposición de cliente
    ...
    private function createDisposition($parameter)
    {
        ...
        print_r($this->registry->api->result);
        if ($this->registry->api->result->createDispositionReturn->resultCode === 0 or $this->registry->api->result->createDispositionReturn->errorCode === 0) {
            print_r($this->registry->api->result->createDispositionReturn);
     ...
     *
     * Genera la URL del panel del cliente en función del modo de operación
