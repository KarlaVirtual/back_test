...
/**
 * Clase para gestionar pagos mediante Paysafecard.
 *
 * Proporciona métodos para crear, capturar y recuperar pagos,
 * así como para manejar errores y configurar el entorno de la API.
 *
 * @category Red
 * @package  API
 * @author   Desconocido
...
/**
 * Controlador de pagos de Paysafecard.
 *
 * Esta clase permite interactuar con la API de Paysafecard para realizar
 * operaciones relacionadas con pagos, como creación, captura y recuperación.
 */
class PaysafecardPaymentController
{
    ...
    /**
     * Información de la última operación cURL.
     *
     * @var array
     */
    private $curl;
    ...
    /**
     * URL base de la API de Paysafecard.
     *
     * @var string
     */
    private $url = "";
     ...
     *
     * @param string $key         Clave de autenticación para la API.
    ...
    /**
     * Obtiene la información de la última operación cURL.
     *
     ...
     * @param string  $notification_url    URL para notificaciones de la API.
     * @param string  $correlation_id      Opcional ID de correlación.
     * @param string  $country_restriction Opcional Restricción por país.
     * @param string  $kyc_restriction     Opcional Restricción KYC.
     ...
     *
     * @return array|boolean Respuesta de la API o `false` en caso de error.
     */
    ...
    /**
     * Configura el entorno de la API (TEST o PRODUCTION).
     *
    ...
    /**
     * Obtiene el error de la última solicitud realizada.
     *
