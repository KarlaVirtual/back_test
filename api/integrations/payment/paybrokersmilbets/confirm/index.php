 ...
 * relevante sobre las transacciones.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payment\PayBrokers
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
...
if (isset($data)) {
    ...
    $header=$PAYBROKERSSERVICES->buildAuthorizationHeader('17', $Usuario);

    $Respueta = $PAYBROKERSSERVICES->ConnectionToken($header, '17', $Usuario);
    ...
    $respuesta=$PAYBROKERSSERVICES->GetPIXPayment($id, $token, '17', $URL);
