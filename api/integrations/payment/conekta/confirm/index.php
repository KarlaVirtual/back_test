...
/**
 * Este archivo maneja la confirmación de pagos a través de la integración con Conekta.
 * Procesa las solicitudes entrantes, valida la acción y realiza las operaciones necesarias
 * según el tipo de acción recibida.
 *
 * @category   Red
 * @package    API
 * @subpackage Integrations\Payment\Conekta
 * @author     Desconocido
 * @version    1.0.0
 * @since      2025-05-09
 */
 ...
 * @var mixed $Conekta      Variable que almacena información relacionada con Conekta.
 */

require(__DIR__ . '../../../../../vendor/autoload.php');

use Backend\integrations\payment\Conekta;
...
if (isset($data)) {
    ...
    if ($ping == "ping") {
        ...
        /* Procesamos */
        $Conekta = new Conekta($invoice, $usuario_id, $documento_id, $valor, $control, $result);
        $Conekta->confirmation(json_encode($data));
    }
}