...
class simplexml
{
    ...
    function array_reindex($array)
    {
        if (is_array($array))
        {
            if ((oldCount($array) == 1) && isset($array[0]))
            {
            ...
            switch ($array[$i]['type']) {
                case 'open':
                    ...
                    if (isset($array[$i]['value']) && ($array[$i]['value'] || !$this->skip_empty_values))
                    {
                        ...
                        $this->array_insert(oldCount($tags), $tags, $array[$i]['value'], "open");
                        array_pop($tags);
                    }
                    ...
                    if (isset($array[$i]['attributes']) && $array[$i]['attributes'] && $array[$i]['level'] != $this->ignore_level) {
                        ...
                        foreach ($array[$i]['attributes'] as $attrkey => $attr)
                        {
                            ...
                            $this->array_insert(oldCount($tags), $tags, $attr, "open");
                            array_pop($tags);
                        }
                        array_pop($tags);
                    }
                ...
                case 'complete':
                    ...
                    if (isset($array[$i]['value']) && ($array[$i]['value'] || !$this->skip_empty_values))
                    {
                        ...
                        {
                            array_push($tags, '@content');
                            $this->array_insert(oldCount($tags), $tags, $array[$i]['value'], "complete");
                            array_pop($tags);
                        }
                        else
                        {
                    ...
                    if (isset($array[$i]['attributes']) && $array[$i]['attributes'])
                    {
                        ...
                        {
                            array_push($tags, $attrkey);
                            $this->array_insert(oldCount($tags), $tags, $attr, "complete");
                            array_pop($tags);
                        }
                        array_pop($tags);
                    }
