...
class SafetyPayProxy
{
    ...
    function __construct()
    {
        ...
        $this->conf['ApiKey'] = '9db5e3fa8354d63bd868964875dda9cd';
        $this->conf['SignatureKey'] = 'd0b6ac6c1bd482d90528de032166f11e';
        ...
        /*
         * Sales Currency Code
         * Samples: USD, GTQ, MXN, EUR.
         * Reverse Amount
         */        
        $this->conf['SalesCurrencyCode'] = 'GTQ';
