...
if (isset($data)) {
    ...
    $header = $PAYBROKERSSERVICES->buildAuthorizationHeader("", $Usuario);

    $Respueta = $PAYBROKERSSERVICES->ConnectionToken($header, "", $Usuario);
    ...
    $respuesta = $PAYBROKERSSERVICES->GetPIXPayment($id, $token, "", $URL);
