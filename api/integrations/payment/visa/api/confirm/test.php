...
/**
 * Este archivo contiene un script para procesar y confirmar transacciones de pago
 * realizadas a través del sistema de pagos Visa. Genera una respuesta en formato
 * HTML que incluye los detalles de la transacción, como el estado, el importe y
